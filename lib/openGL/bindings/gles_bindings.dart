...
class LibOpenGLES {
  ...
  LibOpenGLES(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LibOpenGLES.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup)
      : _lookup = lookup;
  ...
  late final _glActiveTexture_ptr = _lookup<ffi.NativeFunction<_c_glActiveTexture>>('glActiveTexture');
  late final _dart_glActiveTexture _glActiveTexture = _glActiveTexture_ptr.asFunction<_dart_glActiveTexture>();

  void glAttachShader(int program, int shader) {
    return _glAttachShader(program, shader);
  }

  late final _glAttachShader_ptr = _lookup<ffi.NativeFunction<_c_glAttachShader>>('glAttachShader');
  late final _dart_glAttachShader _glAttachShader = _glAttachShader_ptr.asFunction<_dart_glAttachShader>();

  void glBindAttribLocation(int program, int index, ffi.Pointer<ffi.Int8> name) {
    return _glBindAttribLocation(program, index, name);
  }

  late final _glBindAttribLocation_ptr = _lookup<ffi.NativeFunction<_c_glBindAttribLocation>>('glBindAttribLocation');
  ...
  late final _glBindBuffer_ptr = _lookup<ffi.NativeFunction<_c_glBindBuffer>>('glBindBuffer');
  late final _dart_glBindBuffer _glBindBuffer = _glBindBuffer_ptr.asFunction<_dart_glBindBuffer>();

  void glBindFramebuffer(int target, int framebuffer) {
    return _glBindFramebuffer(target, framebuffer);
  }

  late final _glBindFramebuffer_ptr = _lookup<ffi.NativeFunction<_c_glBindFramebuffer>>('glBindFramebuffer');
  late final _dart_glBindFramebuffer _glBindFramebuffer = _glBindFramebuffer_ptr.asFunction<_dart_glBindFramebuffer>();
  ...
  late final _glBindRenderbuffer_ptr = _lookup<ffi.NativeFunction<_c_glBindRenderbuffer>>('glBindRenderbuffer');
  ...
  late final _glBindTexture_ptr = _lookup<ffi.NativeFunction<_c_glBindTexture>>('glBindTexture');
  late final _dart_glBindTexture _glBindTexture = _glBindTexture_ptr.asFunction<_dart_glBindTexture>();
  ...
  late final _glBlendColor_ptr = _lookup<ffi.NativeFunction<_c_glBlendColor>>('glBlendColor');
  late final _dart_glBlendColor _glBlendColor = _glBlendColor_ptr.asFunction<_dart_glBlendColor>();
  ...
  late final _glBlendEquation_ptr = _lookup<ffi.NativeFunction<_c_glBlendEquation>>('glBlendEquation');
  late final _dart_glBlendEquation _glBlendEquation = _glBlendEquation_ptr.asFunction<_dart_glBlendEquation>();
  ...
  late final _glBlendEquationSeparate_ptr =
      _lookup<ffi.NativeFunction<_c_glBlendEquationSeparate>>('glBlendEquationSeparate');
  ...
  late final _glBlendFunc_ptr = _lookup<ffi.NativeFunction<_c_glBlendFunc>>('glBlendFunc');
  late final _dart_glBlendFunc _glBlendFunc = _glBlendFunc_ptr.asFunction<_dart_glBlendFunc>();
  ...
  late final _glBlendFuncSeparate_ptr = _lookup<ffi.NativeFunction<_c_glBlendFuncSeparate>>('glBlendFuncSeparate');
  ...
  late final _glBufferData_ptr = _lookup<ffi.NativeFunction<_c_glBufferData>>('glBufferData');
  late final _dart_glBufferData _glBufferData = _glBufferData_ptr.asFunction<_dart_glBufferData>();
  ...
  late final _glBufferSubData_ptr = _lookup<ffi.NativeFunction<_c_glBufferSubData>>('glBufferSubData');
  late final _dart_glBufferSubData _glBufferSubData = _glBufferSubData_ptr.asFunction<_dart_glBufferSubData>();
  ...
  late final _glCheckFramebufferStatus_ptr =
      _lookup<ffi.NativeFunction<_c_glCheckFramebufferStatus>>('glCheckFramebufferStatus');
  late final _dart_glCheckFramebufferStatus _glCheckFramebufferStatus =
      _glCheckFramebufferStatus_ptr.asFunction<_dart_glCheckFramebufferStatus>();
  ...
  late final _glClearColor_ptr = _lookup<ffi.NativeFunction<_c_glClearColor>>('glClearColor');
  late final _dart_glClearColor _glClearColor = _glClearColor_ptr.asFunction<_dart_glClearColor>();
  ...
  late final _glClearDepthf_ptr = _lookup<ffi.NativeFunction<_c_glClearDepthf>>('glClearDepthf');
  late final _dart_glClearDepthf _glClearDepthf = _glClearDepthf_ptr.asFunction<_dart_glClearDepthf>();
  ...
  late final _glClearStencil_ptr = _lookup<ffi.NativeFunction<_c_glClearStencil>>('glClearStencil');
  late final _dart_glClearStencil _glClearStencil = _glClearStencil_ptr.asFunction<_dart_glClearStencil>();
  ...
  late final _glColorMask_ptr = _lookup<ffi.NativeFunction<_c_glColorMask>>('glColorMask');
  late final _dart_glColorMask _glColorMask = _glColorMask_ptr.asFunction<_dart_glColorMask>();
  ...
  late final _glCompileShader_ptr = _lookup<ffi.NativeFunction<_c_glCompileShader>>('glCompileShader');
  late final _dart_glCompileShader _glCompileShader = _glCompileShader_ptr.asFunction<_dart_glCompileShader>();
  ...
  late final _glCompressedTexImage2D_ptr =
      _lookup<ffi.NativeFunction<_c_glCompressedTexImage2D>>('glCompressedTexImage2D');
  ...
  late final _glCompressedTexSubImage2D_ptr =
      _lookup<ffi.NativeFunction<_c_glCompressedTexSubImage2D>>('glCompressedTexSubImage2D');
  late final _dart_glCompressedTexSubImage2D _glCompressedTexSubImage2D =
      _glCompressedTexSubImage2D_ptr.asFunction<_dart_glCompressedTexSubImage2D>();
  ...
  late final _glCopyTexImage2D_ptr = _lookup<ffi.NativeFunction<_c_glCopyTexImage2D>>('glCopyTexImage2D');
  late final _dart_glCopyTexImage2D _glCopyTexImage2D = _glCopyTexImage2D_ptr.asFunction<_dart_glCopyTexImage2D>();
  ...
  late final _glCopyTexSubImage2D_ptr = _lookup<ffi.NativeFunction<_c_glCopyTexSubImage2D>>('glCopyTexSubImage2D');
  ...
  late final _glCreateProgram_ptr = _lookup<ffi.NativeFunction<_c_glCreateProgram>>('glCreateProgram');
  late final _dart_glCreateProgram _glCreateProgram = _glCreateProgram_ptr.asFunction<_dart_glCreateProgram>();
  ...
  late final _glCreateShader_ptr = _lookup<ffi.NativeFunction<_c_glCreateShader>>('glCreateShader');
  late final _dart_glCreateShader _glCreateShader = _glCreateShader_ptr.asFunction<_dart_glCreateShader>();
  ...
  late final _glCullFace_ptr = _lookup<ffi.NativeFunction<_c_glCullFace>>('glCullFace');
  late final _dart_glCullFace _glCullFace = _glCullFace_ptr.asFunction<_dart_glCullFace>();
  ...
  late final _glDeleteBuffers_ptr = _lookup<ffi.NativeFunction<_c_glDeleteBuffers>>('glDeleteBuffers');
  late final _dart_glDeleteBuffers _glDeleteBuffers = _glDeleteBuffers_ptr.asFunction<_dart_glDeleteBuffers>();
  ...
  late final _glDeleteFramebuffers_ptr = _lookup<ffi.NativeFunction<_c_glDeleteFramebuffers>>('glDeleteFramebuffers');
  ...
  late final _glDeleteProgram_ptr = _lookup<ffi.NativeFunction<_c_glDeleteProgram>>('glDeleteProgram');
  late final _dart_glDeleteProgram _glDeleteProgram = _glDeleteProgram_ptr.asFunction<_dart_glDeleteProgram>();
  ...
  late final _glDeleteRenderbuffers_ptr =
      _lookup<ffi.NativeFunction<_c_glDeleteRenderbuffers>>('glDeleteRenderbuffers');
  ...
  late final _glDeleteShader_ptr = _lookup<ffi.NativeFunction<_c_glDeleteShader>>('glDeleteShader');
  late final _dart_glDeleteShader _glDeleteShader = _glDeleteShader_ptr.asFunction<_dart_glDeleteShader>();
  ...
  late final _glDeleteTextures_ptr = _lookup<ffi.NativeFunction<_c_glDeleteTextures>>('glDeleteTextures');
  late final _dart_glDeleteTextures _glDeleteTextures = _glDeleteTextures_ptr.asFunction<_dart_glDeleteTextures>();
  ...
  late final _glDepthFunc_ptr = _lookup<ffi.NativeFunction<_c_glDepthFunc>>('glDepthFunc');
  late final _dart_glDepthFunc _glDepthFunc = _glDepthFunc_ptr.asFunction<_dart_glDepthFunc>();
  ...
  late final _glDepthMask_ptr = _lookup<ffi.NativeFunction<_c_glDepthMask>>('glDepthMask');
  late final _dart_glDepthMask _glDepthMask = _glDepthMask_ptr.asFunction<_dart_glDepthMask>();
  ...
  late final _glDepthRangef_ptr = _lookup<ffi.NativeFunction<_c_glDepthRangef>>('glDepthRangef');
  late final _dart_glDepthRangef _glDepthRangef = _glDepthRangef_ptr.asFunction<_dart_glDepthRangef>();
  ...
  late final _glDetachShader_ptr = _lookup<ffi.NativeFunction<_c_glDetachShader>>('glDetachShader');
  late final _dart_glDetachShader _glDetachShader = _glDetachShader_ptr.asFunction<_dart_glDetachShader>();
  ...
  late final _glDisable_ptr = _lookup<ffi.NativeFunction<_c_glDisable>>('glDisable');
  late final _dart_glDisable _glDisable = _glDisable_ptr.asFunction<_dart_glDisable>();
  ...
  late final _glDisableVertexAttribArray_ptr =
      _lookup<ffi.NativeFunction<_c_glDisableVertexAttribArray>>('glDisableVertexAttribArray');
  late final _dart_glDisableVertexAttribArray _glDisableVertexAttribArray =
      _glDisableVertexAttribArray_ptr.asFunction<_dart_glDisableVertexAttribArray>();
  ...
  late final _glDrawArrays_ptr = _lookup<ffi.NativeFunction<_c_glDrawArrays>>('glDrawArrays');
  late final _dart_glDrawArrays _glDrawArrays = _glDrawArrays_ptr.asFunction<_dart_glDrawArrays>();
  ...
  late final _glDrawElements_ptr = _lookup<ffi.NativeFunction<_c_glDrawElements>>('glDrawElements');
  late final _dart_glDrawElements _glDrawElements = _glDrawElements_ptr.asFunction<_dart_glDrawElements>();
  ...
  late final _glEnable_ptr = _lookup<ffi.NativeFunction<_c_glEnable>>('glEnable');
  late final _dart_glEnable _glEnable = _glEnable_ptr.asFunction<_dart_glEnable>();
  ...
  late final _glEnableVertexAttribArray_ptr =
      _lookup<ffi.NativeFunction<_c_glEnableVertexAttribArray>>('glEnableVertexAttribArray');
  late final _dart_glEnableVertexAttribArray _glEnableVertexAttribArray =
      _glEnableVertexAttribArray_ptr.asFunction<_dart_glEnableVertexAttribArray>();

  void glFinish() {
    return _glFinish();
  }

  late final _glFinish_ptr = _lookup<ffi.NativeFunction<_c_glFinish>>('glFinish');
  late final _dart_glFinish _glFinish = _glFinish_ptr.asFunction<_dart_glFinish>();
  ...
  late final _glFramebufferRenderbuffer_ptr =
      _lookup<ffi.NativeFunction<_c_glFramebufferRenderbuffer>>('glFramebufferRenderbuffer');
  late final _dart_glFramebufferRenderbuffer _glFramebufferRenderbuffer =
      _glFramebufferRenderbuffer_ptr.asFunction<_dart_glFramebufferRenderbuffer>();
  ...
  late final _glFramebufferTexture2D_ptr =
      _lookup<ffi.NativeFunction<_c_glFramebufferTexture2D>>('glFramebufferTexture2D');
  ...
  late final _glFrontFace_ptr = _lookup<ffi.NativeFunction<_c_glFrontFace>>('glFrontFace');
  late final _dart_glFrontFace _glFrontFace = _glFrontFace_ptr.asFunction<_dart_glFrontFace>();
  ...
  late final _glGenBuffers_ptr = _lookup<ffi.NativeFunction<_c_glGenBuffers>>('glGenBuffers');
  late final _dart_glGenBuffers _glGenBuffers = _glGenBuffers_ptr.asFunction<_dart_glGenBuffers>();
  ...
  late final _glGenerateMipmap_ptr = _lookup<ffi.NativeFunction<_c_glGenerateMipmap>>('glGenerateMipmap');
  late final _dart_glGenerateMipmap _glGenerateMipmap = _glGenerateMipmap_ptr.asFunction<_dart_glGenerateMipmap>();
  ...
  late final _glGenFramebuffers_ptr = _lookup<ffi.NativeFunction<_c_glGenFramebuffers>>('glGenFramebuffers');
  late final _dart_glGenFramebuffers _glGenFramebuffers = _glGenFramebuffers_ptr.asFunction<_dart_glGenFramebuffers>();
  ...
  late final _glGenRenderbuffers_ptr = _lookup<ffi.NativeFunction<_c_glGenRenderbuffers>>('glGenRenderbuffers');
  ...
  late final _glGenTextures_ptr = _lookup<ffi.NativeFunction<_c_glGenTextures>>('glGenTextures');
  late final _dart_glGenTextures _glGenTextures = _glGenTextures_ptr.asFunction<_dart_glGenTextures>();
  ...
  late final _glGetActiveAttrib_ptr = _lookup<ffi.NativeFunction<_c_glGetActiveAttrib>>('glGetActiveAttrib');
  late final _dart_glGetActiveAttrib _glGetActiveAttrib = _glGetActiveAttrib_ptr.asFunction<_dart_glGetActiveAttrib>();
  ...
  late final _glGetActiveUniform_ptr = _lookup<ffi.NativeFunction<_c_glGetActiveUniform>>('glGetActiveUniform');
  ...
  late final _glGetAttachedShaders_ptr = _lookup<ffi.NativeFunction<_c_glGetAttachedShaders>>('glGetAttachedShaders');
  ...
  late final _glGetAttribLocation_ptr = _lookup<ffi.NativeFunction<_c_glGetAttribLocation>>('glGetAttribLocation');
  ...
  late final _glGetBooleanv_ptr = _lookup<ffi.NativeFunction<_c_glGetBooleanv>>('glGetBooleanv');
  late final _dart_glGetBooleanv _glGetBooleanv = _glGetBooleanv_ptr.asFunction<_dart_glGetBooleanv>();
  ...
  late final _glGetBufferParameteriv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetBufferParameteriv>>('glGetBufferParameteriv');
  ...
  late final _glGetError_ptr = _lookup<ffi.NativeFunction<_c_glGetError>>('glGetError');
  late final _dart_glGetError _glGetError = _glGetError_ptr.asFunction<_dart_glGetError>();
  ...
  late final _glGetFloatv_ptr = _lookup<ffi.NativeFunction<_c_glGetFloatv>>('glGetFloatv');
  late final _dart_glGetFloatv _glGetFloatv = _glGetFloatv_ptr.asFunction<_dart_glGetFloatv>();
  ...
  late final _glGetFramebufferAttachmentParameteriv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetFramebufferAttachmentParameteriv>>('glGetFramebufferAttachmentParameteriv');
  late final _dart_glGetFramebufferAttachmentParameteriv _glGetFramebufferAttachmentParameteriv =
      _glGetFramebufferAttachmentParameteriv_ptr.asFunction<_dart_glGetFramebufferAttachmentParameteriv>();
  ...
  late final _glGetIntegerv_ptr = _lookup<ffi.NativeFunction<_c_glGetIntegerv>>('glGetIntegerv');
  late final _dart_glGetIntegerv _glGetIntegerv = _glGetIntegerv_ptr.asFunction<_dart_glGetIntegerv>();
  ...
  late final _glGetProgramiv_ptr = _lookup<ffi.NativeFunction<_c_glGetProgramiv>>('glGetProgramiv');
  late final _dart_glGetProgramiv _glGetProgramiv = _glGetProgramiv_ptr.asFunction<_dart_glGetProgramiv>();
  ...
  late final _glGetProgramInfoLog_ptr = _lookup<ffi.NativeFunction<_c_glGetProgramInfoLog>>('glGetProgramInfoLog');
  ...
  late final _glGetRenderbufferParameteriv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetRenderbufferParameteriv>>('glGetRenderbufferParameteriv');
  late final _dart_glGetRenderbufferParameteriv _glGetRenderbufferParameteriv =
      _glGetRenderbufferParameteriv_ptr.asFunction<_dart_glGetRenderbufferParameteriv>();
  ...
  late final _glGetShaderiv_ptr = _lookup<ffi.NativeFunction<_c_glGetShaderiv>>('glGetShaderiv');
  late final _dart_glGetShaderiv _glGetShaderiv = _glGetShaderiv_ptr.asFunction<_dart_glGetShaderiv>();
  ...
  late final _glGetShaderInfoLog_ptr = _lookup<ffi.NativeFunction<_c_glGetShaderInfoLog>>('glGetShaderInfoLog');
  ...
  late final _glGetShaderPrecisionFormat_ptr =
      _lookup<ffi.NativeFunction<_c_glGetShaderPrecisionFormat>>('glGetShaderPrecisionFormat');
  late final _dart_glGetShaderPrecisionFormat _glGetShaderPrecisionFormat =
      _glGetShaderPrecisionFormat_ptr.asFunction<_dart_glGetShaderPrecisionFormat>();
  ...
  late final _glGetShaderSource_ptr = _lookup<ffi.NativeFunction<_c_glGetShaderSource>>('glGetShaderSource');
  late final _dart_glGetShaderSource _glGetShaderSource = _glGetShaderSource_ptr.asFunction<_dart_glGetShaderSource>();
  ...
  late final _glGetString_ptr = _lookup<ffi.NativeFunction<_c_glGetString>>('glGetString');
  late final _dart_glGetString _glGetString = _glGetString_ptr.asFunction<_dart_glGetString>();
  ...
  late final _glGetTexParameterfv_ptr = _lookup<ffi.NativeFunction<_c_glGetTexParameterfv>>('glGetTexParameterfv');
  ...
  late final _glGetTexParameteriv_ptr = _lookup<ffi.NativeFunction<_c_glGetTexParameteriv>>('glGetTexParameteriv');
  ...
  late final _glGetUniformfv_ptr = _lookup<ffi.NativeFunction<_c_glGetUniformfv>>('glGetUniformfv');
  late final _dart_glGetUniformfv _glGetUniformfv = _glGetUniformfv_ptr.asFunction<_dart_glGetUniformfv>();
  ...
  late final _glGetUniformiv_ptr = _lookup<ffi.NativeFunction<_c_glGetUniformiv>>('glGetUniformiv');
  late final _dart_glGetUniformiv _glGetUniformiv = _glGetUniformiv_ptr.asFunction<_dart_glGetUniformiv>();
  ...
  late final _glGetUniformLocation_ptr = _lookup<ffi.NativeFunction<_c_glGetUniformLocation>>('glGetUniformLocation');
  ...
  late final _glGetVertexAttribfv_ptr = _lookup<ffi.NativeFunction<_c_glGetVertexAttribfv>>('glGetVertexAttribfv');
  ...
  late final _glGetVertexAttribiv_ptr = _lookup<ffi.NativeFunction<_c_glGetVertexAttribiv>>('glGetVertexAttribiv');
  ...
  late final _glGetVertexAttribPointerv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetVertexAttribPointerv>>('glGetVertexAttribPointerv');
  late final _dart_glGetVertexAttribPointerv _glGetVertexAttribPointerv =
      _glGetVertexAttribPointerv_ptr.asFunction<_dart_glGetVertexAttribPointerv>();
  ...
  late final _glIsBuffer_ptr = _lookup<ffi.NativeFunction<_c_glIsBuffer>>('glIsBuffer');
  late final _dart_glIsBuffer _glIsBuffer = _glIsBuffer_ptr.asFunction<_dart_glIsBuffer>();
  ...
  late final _glIsEnabled_ptr = _lookup<ffi.NativeFunction<_c_glIsEnabled>>('glIsEnabled');
  late final _dart_glIsEnabled _glIsEnabled = _glIsEnabled_ptr.asFunction<_dart_glIsEnabled>();
  ...
  late final _glIsFramebuffer_ptr = _lookup<ffi.NativeFunction<_c_glIsFramebuffer>>('glIsFramebuffer');
  late final _dart_glIsFramebuffer _glIsFramebuffer = _glIsFramebuffer_ptr.asFunction<_dart_glIsFramebuffer>();
  ...
  late final _glIsProgram_ptr = _lookup<ffi.NativeFunction<_c_glIsProgram>>('glIsProgram');
  late final _dart_glIsProgram _glIsProgram = _glIsProgram_ptr.asFunction<_dart_glIsProgram>();
  ...
  late final _glIsRenderbuffer_ptr = _lookup<ffi.NativeFunction<_c_glIsRenderbuffer>>('glIsRenderbuffer');
  late final _dart_glIsRenderbuffer _glIsRenderbuffer = _glIsRenderbuffer_ptr.asFunction<_dart_glIsRenderbuffer>();
  ...
  late final _glIsShader_ptr = _lookup<ffi.NativeFunction<_c_glIsShader>>('glIsShader');
  late final _dart_glIsShader _glIsShader = _glIsShader_ptr.asFunction<_dart_glIsShader>();
  ...
  late final _glIsTexture_ptr = _lookup<ffi.NativeFunction<_c_glIsTexture>>('glIsTexture');
  late final _dart_glIsTexture _glIsTexture = _glIsTexture_ptr.asFunction<_dart_glIsTexture>();
  ...
  late final _glLineWidth_ptr = _lookup<ffi.NativeFunction<_c_glLineWidth>>('glLineWidth');
  late final _dart_glLineWidth _glLineWidth = _glLineWidth_ptr.asFunction<_dart_glLineWidth>();
  ...
  late final _glLinkProgram_ptr = _lookup<ffi.NativeFunction<_c_glLinkProgram>>('glLinkProgram');
  late final _dart_glLinkProgram _glLinkProgram = _glLinkProgram_ptr.asFunction<_dart_glLinkProgram>();
  ...
  late final _glPixelStorei_ptr = _lookup<ffi.NativeFunction<_c_glPixelStorei>>('glPixelStorei');
  late final _dart_glPixelStorei _glPixelStorei = _glPixelStorei_ptr.asFunction<_dart_glPixelStorei>();
  ...
  late final _glPolygonOffset_ptr = _lookup<ffi.NativeFunction<_c_glPolygonOffset>>('glPolygonOffset');
  late final _dart_glPolygonOffset _glPolygonOffset = _glPolygonOffset_ptr.asFunction<_dart_glPolygonOffset>();
  ...
  late final _glReadPixels_ptr = _lookup<ffi.NativeFunction<_c_glReadPixels>>('glReadPixels');
  late final _dart_glReadPixels _glReadPixels = _glReadPixels_ptr.asFunction<_dart_glReadPixels>();
  ...
  late final _glReleaseShaderCompiler_ptr =
      _lookup<ffi.NativeFunction<_c_glReleaseShaderCompiler>>('glReleaseShaderCompiler');
  ...
  late final _glRenderbufferStorage_ptr =
      _lookup<ffi.NativeFunction<_c_glRenderbufferStorage>>('glRenderbufferStorage');
  ...
  late final _glSampleCoverage_ptr = _lookup<ffi.NativeFunction<_c_glSampleCoverage>>('glSampleCoverage');
  late final _dart_glSampleCoverage _glSampleCoverage = _glSampleCoverage_ptr.asFunction<_dart_glSampleCoverage>();
  ...
  late final _glScissor_ptr = _lookup<ffi.NativeFunction<_c_glScissor>>('glScissor');
  late final _dart_glScissor _glScissor = _glScissor_ptr.asFunction<_dart_glScissor>();
  ...
  late final _glShaderBinary_ptr = _lookup<ffi.NativeFunction<_c_glShaderBinary>>('glShaderBinary');
  late final _dart_glShaderBinary _glShaderBinary = _glShaderBinary_ptr.asFunction<_dart_glShaderBinary>();
  ...
  late final _glShaderSource_ptr = _lookup<ffi.NativeFunction<_c_glShaderSource>>('glShaderSource');
  late final _dart_glShaderSource _glShaderSource = _glShaderSource_ptr.asFunction<_dart_glShaderSource>();
  ...
  late final _glStencilFunc_ptr = _lookup<ffi.NativeFunction<_c_glStencilFunc>>('glStencilFunc');
  late final _dart_glStencilFunc _glStencilFunc = _glStencilFunc_ptr.asFunction<_dart_glStencilFunc>();
  ...
  late final _glStencilFuncSeparate_ptr =
      _lookup<ffi.NativeFunction<_c_glStencilFuncSeparate>>('glStencilFuncSeparate');
  ...
  late final _glStencilMask_ptr = _lookup<ffi.NativeFunction<_c_glStencilMask>>('glStencilMask');
  late final _dart_glStencilMask _glStencilMask = _glStencilMask_ptr.asFunction<_dart_glStencilMask>();
  ...
  late final _glStencilMaskSeparate_ptr =
      _lookup<ffi.NativeFunction<_c_glStencilMaskSeparate>>('glStencilMaskSeparate');
  ...
  late final _glStencilOp_ptr = _lookup<ffi.NativeFunction<_c_glStencilOp>>('glStencilOp');
  late final _dart_glStencilOp _glStencilOp = _glStencilOp_ptr.asFunction<_dart_glStencilOp>();
  ...
  late final _glStencilOpSeparate_ptr = _lookup<ffi.NativeFunction<_c_glStencilOpSeparate>>('glStencilOpSeparate');
  ...
  late final _glTexImage2D_ptr = _lookup<ffi.NativeFunction<_c_glTexImage2D>>('glTexImage2D');
  late final _dart_glTexImage2D _glTexImage2D = _glTexImage2D_ptr.asFunction<_dart_glTexImage2D>();
  ...
  late final _glTexParameterf_ptr = _lookup<ffi.NativeFunction<_c_glTexParameterf>>('glTexParameterf');
  late final _dart_glTexParameterf _glTexParameterf = _glTexParameterf_ptr.asFunction<_dart_glTexParameterf>();
  ...
  late final _glTexParameterfv_ptr = _lookup<ffi.NativeFunction<_c_glTexParameterfv>>('glTexParameterfv');
  late final _dart_glTexParameterfv _glTexParameterfv = _glTexParameterfv_ptr.asFunction<_dart_glTexParameterfv>();
  ...
  late final _glTexParameteri_ptr = _lookup<ffi.NativeFunction<_c_glTexParameteri>>('glTexParameteri');
  late final _dart_glTexParameteri _glTexParameteri = _glTexParameteri_ptr.asFunction<_dart_glTexParameteri>();
  ...
  late final _glTexParameteriv_ptr = _lookup<ffi.NativeFunction<_c_glTexParameteriv>>('glTexParameteriv');
  late final _dart_glTexParameteriv _glTexParameteriv = _glTexParameteriv_ptr.asFunction<_dart_glTexParameteriv>();
  ...
  late final _glTexSubImage2D_ptr = _lookup<ffi.NativeFunction<_c_glTexSubImage2D>>('glTexSubImage2D');
  late final _dart_glTexSubImage2D _glTexSubImage2D = _glTexSubImage2D_ptr.asFunction<_dart_glTexSubImage2D>();
  ...
  late final _glUniform1f_ptr = _lookup<ffi.NativeFunction<_c_glUniform1f>>('glUniform1f');
  late final _dart_glUniform1f _glUniform1f = _glUniform1f_ptr.asFunction<_dart_glUniform1f>();
  ...
  late final _glUniform1fv_ptr = _lookup<ffi.NativeFunction<_c_glUniform1fv>>('glUniform1fv');
  late final _dart_glUniform1fv _glUniform1fv = _glUniform1fv_ptr.asFunction<_dart_glUniform1fv>();
  ...
  late final _glUniform1i_ptr = _lookup<ffi.NativeFunction<_c_glUniform1i>>('glUniform1i');
  late final _dart_glUniform1i _glUniform1i = _glUniform1i_ptr.asFunction<_dart_glUniform1i>();
  ...
  late final _glUniform1iv_ptr = _lookup<ffi.NativeFunction<_c_glUniform1iv>>('glUniform1iv');
  late final _dart_glUniform1iv _glUniform1iv = _glUniform1iv_ptr.asFunction<_dart_glUniform1iv>();
  ...
  late final _glUniform2f_ptr = _lookup<ffi.NativeFunction<_c_glUniform2f>>('glUniform2f');
  late final _dart_glUniform2f _glUniform2f = _glUniform2f_ptr.asFunction<_dart_glUniform2f>();
  ...
  late final _glUniform2fv_ptr = _lookup<ffi.NativeFunction<_c_glUniform2fv>>('glUniform2fv');
  late final _dart_glUniform2fv _glUniform2fv = _glUniform2fv_ptr.asFunction<_dart_glUniform2fv>();
  ...
  late final _glUniform2i_ptr = _lookup<ffi.NativeFunction<_c_glUniform2i>>('glUniform2i');
  late final _dart_glUniform2i _glUniform2i = _glUniform2i_ptr.asFunction<_dart_glUniform2i>();
  ...
  late final _glUniform2iv_ptr = _lookup<ffi.NativeFunction<_c_glUniform2iv>>('glUniform2iv');
  late final _dart_glUniform2iv _glUniform2iv = _glUniform2iv_ptr.asFunction<_dart_glUniform2iv>();
  ...
  late final _glUniform3f_ptr = _lookup<ffi.NativeFunction<_c_glUniform3f>>('glUniform3f');
  late final _dart_glUniform3f _glUniform3f = _glUniform3f_ptr.asFunction<_dart_glUniform3f>();
  ...
  late final _glUniform3fv_ptr = _lookup<ffi.NativeFunction<_c_glUniform3fv>>('glUniform3fv');
  late final _dart_glUniform3fv _glUniform3fv = _glUniform3fv_ptr.asFunction<_dart_glUniform3fv>();
  ...
  late final _glUniform3i_ptr = _lookup<ffi.NativeFunction<_c_glUniform3i>>('glUniform3i');
  late final _dart_glUniform3i _glUniform3i = _glUniform3i_ptr.asFunction<_dart_glUniform3i>();
  ...
  late final _glUniform3iv_ptr = _lookup<ffi.NativeFunction<_c_glUniform3iv>>('glUniform3iv');
  late final _dart_glUniform3iv _glUniform3iv = _glUniform3iv_ptr.asFunction<_dart_glUniform3iv>();
  ...
  late final _glUniform4f_ptr = _lookup<ffi.NativeFunction<_c_glUniform4f>>('glUniform4f');
  late final _dart_glUniform4f _glUniform4f = _glUniform4f_ptr.asFunction<_dart_glUniform4f>();
  ...
  late final _glUniform4fv_ptr = _lookup<ffi.NativeFunction<_c_glUniform4fv>>('glUniform4fv');
  late final _dart_glUniform4fv _glUniform4fv = _glUniform4fv_ptr.asFunction<_dart_glUniform4fv>();
  ...
  late final _glUniform4i_ptr = _lookup<ffi.NativeFunction<_c_glUniform4i>>('glUniform4i');
  late final _dart_glUniform4i _glUniform4i = _glUniform4i_ptr.asFunction<_dart_glUniform4i>();
  ...
  late final _glUniform4iv_ptr = _lookup<ffi.NativeFunction<_c_glUniform4iv>>('glUniform4iv');
  late final _dart_glUniform4iv _glUniform4iv = _glUniform4iv_ptr.asFunction<_dart_glUniform4iv>();
  ...
  late final _glUniformMatrix2fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix2fv>>('glUniformMatrix2fv');
  ...
  late final _glUniformMatrix3fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix3fv>>('glUniformMatrix3fv');
  ...
  late final _glUniformMatrix4fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix4fv>>('glUniformMatrix4fv');
  ...
  late final _glUseProgram_ptr = _lookup<ffi.NativeFunction<_c_glUseProgram>>('glUseProgram');
  late final _dart_glUseProgram _glUseProgram = _glUseProgram_ptr.asFunction<_dart_glUseProgram>();
  ...
  late final _glValidateProgram_ptr = _lookup<ffi.NativeFunction<_c_glValidateProgram>>('glValidateProgram');
  late final _dart_glValidateProgram _glValidateProgram = _glValidateProgram_ptr.asFunction<_dart_glValidateProgram>();
  ...
  late final _glVertexAttrib1f_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib1f>>('glVertexAttrib1f');
  late final _dart_glVertexAttrib1f _glVertexAttrib1f = _glVertexAttrib1f_ptr.asFunction<_dart_glVertexAttrib1f>();
  ...
  late final _glVertexAttrib1fv_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib1fv>>('glVertexAttrib1fv');
  late final _dart_glVertexAttrib1fv _glVertexAttrib1fv = _glVertexAttrib1fv_ptr.asFunction<_dart_glVertexAttrib1fv>();
  ...
  late final _glVertexAttrib2f_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib2f>>('glVertexAttrib2f');
  late final _dart_glVertexAttrib2f _glVertexAttrib2f = _glVertexAttrib2f_ptr.asFunction<_dart_glVertexAttrib2f>();
  ...
  late final _glVertexAttrib2fv_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib2fv>>('glVertexAttrib2fv');
  late final _dart_glVertexAttrib2fv _glVertexAttrib2fv = _glVertexAttrib2fv_ptr.asFunction<_dart_glVertexAttrib2fv>();
  ...
  late final _glVertexAttrib3f_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib3f>>('glVertexAttrib3f');
  late final _dart_glVertexAttrib3f _glVertexAttrib3f = _glVertexAttrib3f_ptr.asFunction<_dart_glVertexAttrib3f>();
  ...
  late final _glVertexAttrib3fv_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib3fv>>('glVertexAttrib3fv');
  late final _dart_glVertexAttrib3fv _glVertexAttrib3fv = _glVertexAttrib3fv_ptr.asFunction<_dart_glVertexAttrib3fv>();
  ...
  late final _glVertexAttrib4f_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib4f>>('glVertexAttrib4f');
  late final _dart_glVertexAttrib4f _glVertexAttrib4f = _glVertexAttrib4f_ptr.asFunction<_dart_glVertexAttrib4f>();
  ...
  late final _glVertexAttrib4fv_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttrib4fv>>('glVertexAttrib4fv');
  late final _dart_glVertexAttrib4fv _glVertexAttrib4fv = _glVertexAttrib4fv_ptr.asFunction<_dart_glVertexAttrib4fv>();
  ...
  late final _glVertexAttribPointer_ptr =
      _lookup<ffi.NativeFunction<_c_glVertexAttribPointer>>('glVertexAttribPointer');
  ...
  late final _glViewport_ptr = _lookup<ffi.NativeFunction<_c_glViewport>>('glViewport');
  late final _dart_glViewport _glViewport = _glViewport_ptr.asFunction<_dart_glViewport>();
  ...
  late final _glReadBuffer_ptr = _lookup<ffi.NativeFunction<_c_glReadBuffer>>('glReadBuffer');
  late final _dart_glReadBuffer _glReadBuffer = _glReadBuffer_ptr.asFunction<_dart_glReadBuffer>();
  ...
  late final _glDrawRangeElements_ptr = _lookup<ffi.NativeFunction<_c_glDrawRangeElements>>('glDrawRangeElements');
  ...
  late final _glTexImage3D_ptr = _lookup<ffi.NativeFunction<_c_glTexImage3D>>('glTexImage3D');
  late final _dart_glTexImage3D _glTexImage3D = _glTexImage3D_ptr.asFunction<_dart_glTexImage3D>();
  ...
  late final _glTexSubImage3D_ptr = _lookup<ffi.NativeFunction<_c_glTexSubImage3D>>('glTexSubImage3D');
  late final _dart_glTexSubImage3D _glTexSubImage3D = _glTexSubImage3D_ptr.asFunction<_dart_glTexSubImage3D>();
  ...
  late final _glCopyTexSubImage3D_ptr = _lookup<ffi.NativeFunction<_c_glCopyTexSubImage3D>>('glCopyTexSubImage3D');
  ...
  late final _glCompressedTexImage3D_ptr =
      _lookup<ffi.NativeFunction<_c_glCompressedTexImage3D>>('glCompressedTexImage3D');
  ...
  late final _glCompressedTexSubImage3D_ptr =
      _lookup<ffi.NativeFunction<_c_glCompressedTexSubImage3D>>('glCompressedTexSubImage3D');
  late final _dart_glCompressedTexSubImage3D _glCompressedTexSubImage3D =
      _glCompressedTexSubImage3D_ptr.asFunction<_dart_glCompressedTexSubImage3D>();
  ...
  late final _glGenQueries_ptr = _lookup<ffi.NativeFunction<_c_glGenQueries>>('glGenQueries');
  late final _dart_glGenQueries _glGenQueries = _glGenQueries_ptr.asFunction<_dart_glGenQueries>();
  ...
  late final _glDeleteQueries_ptr = _lookup<ffi.NativeFunction<_c_glDeleteQueries>>('glDeleteQueries');
  late final _dart_glDeleteQueries _glDeleteQueries = _glDeleteQueries_ptr.asFunction<_dart_glDeleteQueries>();
  ...
  late final _glIsQuery_ptr = _lookup<ffi.NativeFunction<_c_glIsQuery>>('glIsQuery');
  late final _dart_glIsQuery _glIsQuery = _glIsQuery_ptr.asFunction<_dart_glIsQuery>();
  ...
  late final _glBeginQuery_ptr = _lookup<ffi.NativeFunction<_c_glBeginQuery>>('glBeginQuery');
  late final _dart_glBeginQuery _glBeginQuery = _glBeginQuery_ptr.asFunction<_dart_glBeginQuery>();
  ...
  late final _glEndQuery_ptr = _lookup<ffi.NativeFunction<_c_glEndQuery>>('glEndQuery');
  late final _dart_glEndQuery _glEndQuery = _glEndQuery_ptr.asFunction<_dart_glEndQuery>();
  ...
  late final _glGetQueryiv_ptr = _lookup<ffi.NativeFunction<_c_glGetQueryiv>>('glGetQueryiv');
  late final _dart_glGetQueryiv _glGetQueryiv = _glGetQueryiv_ptr.asFunction<_dart_glGetQueryiv>();
  ...
  late final _glGetQueryObjectuiv_ptr = _lookup<ffi.NativeFunction<_c_glGetQueryObjectuiv>>('glGetQueryObjectuiv');
  ...
  late final _glUnmapBuffer_ptr = _lookup<ffi.NativeFunction<_c_glUnmapBuffer>>('glUnmapBuffer');
  late final _dart_glUnmapBuffer _glUnmapBuffer = _glUnmapBuffer_ptr.asFunction<_dart_glUnmapBuffer>();
  ...
  late final _glGetBufferPointerv_ptr = _lookup<ffi.NativeFunction<_c_glGetBufferPointerv>>('glGetBufferPointerv');
  ...
  late final _glDrawBuffers_ptr = _lookup<ffi.NativeFunction<_c_glDrawBuffers>>('glDrawBuffers');
  late final _dart_glDrawBuffers _glDrawBuffers = _glDrawBuffers_ptr.asFunction<_dart_glDrawBuffers>();
  ...
  late final _glUniformMatrix2x3fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix2x3fv>>('glUniformMatrix2x3fv');
  ...
  late final _glUniformMatrix3x2fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix3x2fv>>('glUniformMatrix3x2fv');
  ...
  late final _glUniformMatrix2x4fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix2x4fv>>('glUniformMatrix2x4fv');
  ...
  late final _glUniformMatrix4x2fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix4x2fv>>('glUniformMatrix4x2fv');
  ...
  late final _glUniformMatrix3x4fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix3x4fv>>('glUniformMatrix3x4fv');
  ...
  late final _glUniformMatrix4x3fv_ptr = _lookup<ffi.NativeFunction<_c_glUniformMatrix4x3fv>>('glUniformMatrix4x3fv');
  ...
  late final _glBlitFramebuffer_ptr = _lookup<ffi.NativeFunction<_c_glBlitFramebuffer>>('glBlitFramebuffer');
  late final _dart_glBlitFramebuffer _glBlitFramebuffer = _glBlitFramebuffer_ptr.asFunction<_dart_glBlitFramebuffer>();
  ...
  late final _glRenderbufferStorageMultisample_ptr =
      _lookup<ffi.NativeFunction<_c_glRenderbufferStorageMultisample>>('glRenderbufferStorageMultisample');
  late final _dart_glRenderbufferStorageMultisample _glRenderbufferStorageMultisample =
      _glRenderbufferStorageMultisample_ptr.asFunction<_dart_glRenderbufferStorageMultisample>();
  ...
  late final _glFramebufferTextureLayer_ptr =
      _lookup<ffi.NativeFunction<_c_glFramebufferTextureLayer>>('glFramebufferTextureLayer');
  late final _dart_glFramebufferTextureLayer _glFramebufferTextureLayer =
      _glFramebufferTextureLayer_ptr.asFunction<_dart_glFramebufferTextureLayer>();
  ...
  late final _glMapBufferRange_ptr = _lookup<ffi.NativeFunction<_c_glMapBufferRange>>('glMapBufferRange');
  late final _dart_glMapBufferRange _glMapBufferRange = _glMapBufferRange_ptr.asFunction<_dart_glMapBufferRange>();
  ...
  late final _glFlushMappedBufferRange_ptr =
      _lookup<ffi.NativeFunction<_c_glFlushMappedBufferRange>>('glFlushMappedBufferRange');
  late final _dart_glFlushMappedBufferRange _glFlushMappedBufferRange =
      _glFlushMappedBufferRange_ptr.asFunction<_dart_glFlushMappedBufferRange>();
  ...
  late final _glBindVertexArray_ptr = _lookup<ffi.NativeFunction<_c_glBindVertexArray>>('glBindVertexArray');
  late final _dart_glBindVertexArray _glBindVertexArray = _glBindVertexArray_ptr.asFunction<_dart_glBindVertexArray>();
  ...
  late final _glDeleteVertexArrays_ptr = _lookup<ffi.NativeFunction<_c_glDeleteVertexArrays>>('glDeleteVertexArrays');
  ...
  late final _glGenVertexArrays_ptr = _lookup<ffi.NativeFunction<_c_glGenVertexArrays>>('glGenVertexArrays');
  late final _dart_glGenVertexArrays _glGenVertexArrays = _glGenVertexArrays_ptr.asFunction<_dart_glGenVertexArrays>();
  ...
  late final _glIsVertexArray_ptr = _lookup<ffi.NativeFunction<_c_glIsVertexArray>>('glIsVertexArray');
  late final _dart_glIsVertexArray _glIsVertexArray = _glIsVertexArray_ptr.asFunction<_dart_glIsVertexArray>();
  ...
  late final _glGetIntegeri_v_ptr = _lookup<ffi.NativeFunction<_c_glGetIntegeri_v>>('glGetIntegeri_v');
  late final _dart_glGetIntegeri_v _glGetIntegeri_v = _glGetIntegeri_v_ptr.asFunction<_dart_glGetIntegeri_v>();
  ...
  late final _glBeginTransformFeedback_ptr =
      _lookup<ffi.NativeFunction<_c_glBeginTransformFeedback>>('glBeginTransformFeedback');
  late final _dart_glBeginTransformFeedback _glBeginTransformFeedback =
      _glBeginTransformFeedback_ptr.asFunction<_dart_glBeginTransformFeedback>();
  ...
  late final _glEndTransformFeedback_ptr =
      _lookup<ffi.NativeFunction<_c_glEndTransformFeedback>>('glEndTransformFeedback');
  ...
  late final _glBindBufferRange_ptr = _lookup<ffi.NativeFunction<_c_glBindBufferRange>>('glBindBufferRange');
  late final _dart_glBindBufferRange _glBindBufferRange = _glBindBufferRange_ptr.asFunction<_dart_glBindBufferRange>();
  ...
  late final _glBindBufferBase_ptr = _lookup<ffi.NativeFunction<_c_glBindBufferBase>>('glBindBufferBase');
  late final _dart_glBindBufferBase _glBindBufferBase = _glBindBufferBase_ptr.asFunction<_dart_glBindBufferBase>();
  ...
  late final _glTransformFeedbackVaryings_ptr =
      _lookup<ffi.NativeFunction<_c_glTransformFeedbackVaryings>>('glTransformFeedbackVaryings');
  late final _dart_glTransformFeedbackVaryings _glTransformFeedbackVaryings =
      _glTransformFeedbackVaryings_ptr.asFunction<_dart_glTransformFeedbackVaryings>();
  ...
  late final _glGetTransformFeedbackVarying_ptr =
      _lookup<ffi.NativeFunction<_c_glGetTransformFeedbackVarying>>('glGetTransformFeedbackVarying');
  late final _dart_glGetTransformFeedbackVarying _glGetTransformFeedbackVarying =
      _glGetTransformFeedbackVarying_ptr.asFunction<_dart_glGetTransformFeedbackVarying>();
  ...
  late final _glVertexAttribIPointer_ptr =
      _lookup<ffi.NativeFunction<_c_glVertexAttribIPointer>>('glVertexAttribIPointer');
  ...
  late final _glGetVertexAttribIiv_ptr = _lookup<ffi.NativeFunction<_c_glGetVertexAttribIiv>>('glGetVertexAttribIiv');
  ...
  late final _glGetVertexAttribIuiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetVertexAttribIuiv>>('glGetVertexAttribIuiv');
  ...
  late final _glVertexAttribI4i_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttribI4i>>('glVertexAttribI4i');
  late final _dart_glVertexAttribI4i _glVertexAttribI4i = _glVertexAttribI4i_ptr.asFunction<_dart_glVertexAttribI4i>();
  ...
  late final _glVertexAttribI4ui_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttribI4ui>>('glVertexAttribI4ui');
  ...
  late final _glVertexAttribI4iv_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttribI4iv>>('glVertexAttribI4iv');
  ...
  late final _glVertexAttribI4uiv_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttribI4uiv>>('glVertexAttribI4uiv');
  ...
  late final _glGetUniformuiv_ptr = _lookup<ffi.NativeFunction<_c_glGetUniformuiv>>('glGetUniformuiv');
  late final _dart_glGetUniformuiv _glGetUniformuiv = _glGetUniformuiv_ptr.asFunction<_dart_glGetUniformuiv>();
  ...
  late final _glGetFragDataLocation_ptr =
      _lookup<ffi.NativeFunction<_c_glGetFragDataLocation>>('glGetFragDataLocation');
  ...
  late final _glUniform1ui_ptr = _lookup<ffi.NativeFunction<_c_glUniform1ui>>('glUniform1ui');
  late final _dart_glUniform1ui _glUniform1ui = _glUniform1ui_ptr.asFunction<_dart_glUniform1ui>();
  ...
  late final _glUniform2ui_ptr = _lookup<ffi.NativeFunction<_c_glUniform2ui>>('glUniform2ui');
  late final _dart_glUniform2ui _glUniform2ui = _glUniform2ui_ptr.asFunction<_dart_glUniform2ui>();
  ...
  late final _glUniform3ui_ptr = _lookup<ffi.NativeFunction<_c_glUniform3ui>>('glUniform3ui');
  late final _dart_glUniform3ui _glUniform3ui = _glUniform3ui_ptr.asFunction<_dart_glUniform3ui>();
  ...
  late final _glUniform4ui_ptr = _lookup<ffi.NativeFunction<_c_glUniform4ui>>('glUniform4ui');
  late final _dart_glUniform4ui _glUniform4ui = _glUniform4ui_ptr.asFunction<_dart_glUniform4ui>();
  ...
  late final _glUniform1uiv_ptr = _lookup<ffi.NativeFunction<_c_glUniform1uiv>>('glUniform1uiv');
  late final _dart_glUniform1uiv _glUniform1uiv = _glUniform1uiv_ptr.asFunction<_dart_glUniform1uiv>();
  ...
  late final _glUniform2uiv_ptr = _lookup<ffi.NativeFunction<_c_glUniform2uiv>>('glUniform2uiv');
  late final _dart_glUniform2uiv _glUniform2uiv = _glUniform2uiv_ptr.asFunction<_dart_glUniform2uiv>();
  ...
  late final _glUniform3uiv_ptr = _lookup<ffi.NativeFunction<_c_glUniform3uiv>>('glUniform3uiv');
  late final _dart_glUniform3uiv _glUniform3uiv = _glUniform3uiv_ptr.asFunction<_dart_glUniform3uiv>();
  ...
  late final _glUniform4uiv_ptr = _lookup<ffi.NativeFunction<_c_glUniform4uiv>>('glUniform4uiv');
  late final _dart_glUniform4uiv _glUniform4uiv = _glUniform4uiv_ptr.asFunction<_dart_glUniform4uiv>();
  ...
  late final _glClearBufferiv_ptr = _lookup<ffi.NativeFunction<_c_glClearBufferiv>>('glClearBufferiv');
  late final _dart_glClearBufferiv _glClearBufferiv = _glClearBufferiv_ptr.asFunction<_dart_glClearBufferiv>();
  ...
  late final _glClearBufferuiv_ptr = _lookup<ffi.NativeFunction<_c_glClearBufferuiv>>('glClearBufferuiv');
  late final _dart_glClearBufferuiv _glClearBufferuiv = _glClearBufferuiv_ptr.asFunction<_dart_glClearBufferuiv>();
  ...
  late final _glClearBufferfv_ptr = _lookup<ffi.NativeFunction<_c_glClearBufferfv>>('glClearBufferfv');
  late final _dart_glClearBufferfv _glClearBufferfv = _glClearBufferfv_ptr.asFunction<_dart_glClearBufferfv>();
  ...
  late final _glClearBufferfi_ptr = _lookup<ffi.NativeFunction<_c_glClearBufferfi>>('glClearBufferfi');
  late final _dart_glClearBufferfi _glClearBufferfi = _glClearBufferfi_ptr.asFunction<_dart_glClearBufferfi>();
  ...
  late final _glGetStringi_ptr = _lookup<ffi.NativeFunction<_c_glGetStringi>>('glGetStringi');
  late final _dart_glGetStringi _glGetStringi = _glGetStringi_ptr.asFunction<_dart_glGetStringi>();
  ...
  late final _glCopyBufferSubData_ptr = _lookup<ffi.NativeFunction<_c_glCopyBufferSubData>>('glCopyBufferSubData');
  ...
  late final _glGetUniformIndices_ptr = _lookup<ffi.NativeFunction<_c_glGetUniformIndices>>('glGetUniformIndices');
  ...
  late final _glGetActiveUniformsiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetActiveUniformsiv>>('glGetActiveUniformsiv');
  ...
  late final _glGetUniformBlockIndex_ptr =
      _lookup<ffi.NativeFunction<_c_glGetUniformBlockIndex>>('glGetUniformBlockIndex');
  ...
  late final _glGetActiveUniformBlockiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetActiveUniformBlockiv>>('glGetActiveUniformBlockiv');
  late final _dart_glGetActiveUniformBlockiv _glGetActiveUniformBlockiv =
      _glGetActiveUniformBlockiv_ptr.asFunction<_dart_glGetActiveUniformBlockiv>();
  ...
  late final _glGetActiveUniformBlockName_ptr =
      _lookup<ffi.NativeFunction<_c_glGetActiveUniformBlockName>>('glGetActiveUniformBlockName');
  late final _dart_glGetActiveUniformBlockName _glGetActiveUniformBlockName =
      _glGetActiveUniformBlockName_ptr.asFunction<_dart_glGetActiveUniformBlockName>();
  ...
  late final _glUniformBlockBinding_ptr =
      _lookup<ffi.NativeFunction<_c_glUniformBlockBinding>>('glUniformBlockBinding');
  ...
  late final _glDrawArraysInstanced_ptr =
      _lookup<ffi.NativeFunction<_c_glDrawArraysInstanced>>('glDrawArraysInstanced');
  ...
  late final _glDrawElementsInstanced_ptr =
      _lookup<ffi.NativeFunction<_c_glDrawElementsInstanced>>('glDrawElementsInstanced');
  ...
  late final _glFenceSync_ptr = _lookup<ffi.NativeFunction<_c_glFenceSync>>('glFenceSync');
  late final _dart_glFenceSync _glFenceSync = _glFenceSync_ptr.asFunction<_dart_glFenceSync>();
  ...
  late final _glIsSync_ptr = _lookup<ffi.NativeFunction<_c_glIsSync>>('glIsSync');
  late final _dart_glIsSync _glIsSync = _glIsSync_ptr.asFunction<_dart_glIsSync>();
  ...
  late final _glDeleteSync_ptr = _lookup<ffi.NativeFunction<_c_glDeleteSync>>('glDeleteSync');
  late final _dart_glDeleteSync _glDeleteSync = _glDeleteSync_ptr.asFunction<_dart_glDeleteSync>();
  ...
  late final _glClientWaitSync_ptr = _lookup<ffi.NativeFunction<_c_glClientWaitSync>>('glClientWaitSync');
  late final _dart_glClientWaitSync _glClientWaitSync = _glClientWaitSync_ptr.asFunction<_dart_glClientWaitSync>();
  ...
  late final _glWaitSync_ptr = _lookup<ffi.NativeFunction<_c_glWaitSync>>('glWaitSync');
  late final _dart_glWaitSync _glWaitSync = _glWaitSync_ptr.asFunction<_dart_glWaitSync>();
  ...
  late final _glGetInteger64v_ptr = _lookup<ffi.NativeFunction<_c_glGetInteger64v>>('glGetInteger64v');
  late final _dart_glGetInteger64v _glGetInteger64v = _glGetInteger64v_ptr.asFunction<_dart_glGetInteger64v>();
  ...
  late final _glGetSynciv_ptr = _lookup<ffi.NativeFunction<_c_glGetSynciv>>('glGetSynciv');
  late final _dart_glGetSynciv _glGetSynciv = _glGetSynciv_ptr.asFunction<_dart_glGetSynciv>();
  ...
  late final _glGetInteger64i_v_ptr = _lookup<ffi.NativeFunction<_c_glGetInteger64i_v>>('glGetInteger64i_v');
  late final _dart_glGetInteger64i_v _glGetInteger64i_v = _glGetInteger64i_v_ptr.asFunction<_dart_glGetInteger64i_v>();
  ...
  late final _glGetBufferParameteri64v_ptr =
      _lookup<ffi.NativeFunction<_c_glGetBufferParameteri64v>>('glGetBufferParameteri64v');
  late final _dart_glGetBufferParameteri64v _glGetBufferParameteri64v =
      _glGetBufferParameteri64v_ptr.asFunction<_dart_glGetBufferParameteri64v>();
  ...
  late final _glGenSamplers_ptr = _lookup<ffi.NativeFunction<_c_glGenSamplers>>('glGenSamplers');
  late final _dart_glGenSamplers _glGenSamplers = _glGenSamplers_ptr.asFunction<_dart_glGenSamplers>();
  ...
  late final _glDeleteSamplers_ptr = _lookup<ffi.NativeFunction<_c_glDeleteSamplers>>('glDeleteSamplers');
  late final _dart_glDeleteSamplers _glDeleteSamplers = _glDeleteSamplers_ptr.asFunction<_dart_glDeleteSamplers>();
  ...
  late final _glIsSampler_ptr = _lookup<ffi.NativeFunction<_c_glIsSampler>>('glIsSampler');
  late final _dart_glIsSampler _glIsSampler = _glIsSampler_ptr.asFunction<_dart_glIsSampler>();
  ...
  late final _glBindSampler_ptr = _lookup<ffi.NativeFunction<_c_glBindSampler>>('glBindSampler');
  late final _dart_glBindSampler _glBindSampler = _glBindSampler_ptr.asFunction<_dart_glBindSampler>();
  ...
  late final _glSamplerParameteri_ptr = _lookup<ffi.NativeFunction<_c_glSamplerParameteri>>('glSamplerParameteri');
  ...
  late final _glSamplerParameteriv_ptr = _lookup<ffi.NativeFunction<_c_glSamplerParameteriv>>('glSamplerParameteriv');
  ...
  late final _glSamplerParameterf_ptr = _lookup<ffi.NativeFunction<_c_glSamplerParameterf>>('glSamplerParameterf');
  ...
  late final _glSamplerParameterfv_ptr = _lookup<ffi.NativeFunction<_c_glSamplerParameterfv>>('glSamplerParameterfv');
  ...
  late final _glGetSamplerParameteriv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetSamplerParameteriv>>('glGetSamplerParameteriv');
  ...
  late final _glGetSamplerParameterfv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetSamplerParameterfv>>('glGetSamplerParameterfv');
  ...
  late final _glVertexAttribDivisor_ptr =
      _lookup<ffi.NativeFunction<_c_glVertexAttribDivisor>>('glVertexAttribDivisor');
  ...
  late final _glBindTransformFeedback_ptr =
      _lookup<ffi.NativeFunction<_c_glBindTransformFeedback>>('glBindTransformFeedback');
  ...
  late final _glDeleteTransformFeedbacks_ptr =
      _lookup<ffi.NativeFunction<_c_glDeleteTransformFeedbacks>>('glDeleteTransformFeedbacks');
  late final _dart_glDeleteTransformFeedbacks _glDeleteTransformFeedbacks =
      _glDeleteTransformFeedbacks_ptr.asFunction<_dart_glDeleteTransformFeedbacks>();
  ...
  late final _glGenTransformFeedbacks_ptr =
      _lookup<ffi.NativeFunction<_c_glGenTransformFeedbacks>>('glGenTransformFeedbacks');
  ...
  late final _glIsTransformFeedback_ptr =
      _lookup<ffi.NativeFunction<_c_glIsTransformFeedback>>('glIsTransformFeedback');
  ...
  late final _glPauseTransformFeedback_ptr =
      _lookup<ffi.NativeFunction<_c_glPauseTransformFeedback>>('glPauseTransformFeedback');
  late final _dart_glPauseTransformFeedback _glPauseTransformFeedback =
      _glPauseTransformFeedback_ptr.asFunction<_dart_glPauseTransformFeedback>();
  ...
  late final _glResumeTransformFeedback_ptr =
      _lookup<ffi.NativeFunction<_c_glResumeTransformFeedback>>('glResumeTransformFeedback');
  late final _dart_glResumeTransformFeedback _glResumeTransformFeedback =
      _glResumeTransformFeedback_ptr.asFunction<_dart_glResumeTransformFeedback>();
  ...
  late final _glGetProgramBinary_ptr = _lookup<ffi.NativeFunction<_c_glGetProgramBinary>>('glGetProgramBinary');
  ...
  late final _glProgramBinary_ptr = _lookup<ffi.NativeFunction<_c_glProgramBinary>>('glProgramBinary');
  late final _dart_glProgramBinary _glProgramBinary = _glProgramBinary_ptr.asFunction<_dart_glProgramBinary>();
  ...
  late final _glProgramParameteri_ptr = _lookup<ffi.NativeFunction<_c_glProgramParameteri>>('glProgramParameteri');
  ...
  late final _glInvalidateFramebuffer_ptr =
      _lookup<ffi.NativeFunction<_c_glInvalidateFramebuffer>>('glInvalidateFramebuffer');
  ...
  late final _glInvalidateSubFramebuffer_ptr =
      _lookup<ffi.NativeFunction<_c_glInvalidateSubFramebuffer>>('glInvalidateSubFramebuffer');
  late final _dart_glInvalidateSubFramebuffer _glInvalidateSubFramebuffer =
      _glInvalidateSubFramebuffer_ptr.asFunction<_dart_glInvalidateSubFramebuffer>();
  ...
  late final _glTexStorage2D_ptr = _lookup<ffi.NativeFunction<_c_glTexStorage2D>>('glTexStorage2D');
  late final _dart_glTexStorage2D _glTexStorage2D = _glTexStorage2D_ptr.asFunction<_dart_glTexStorage2D>();
  ...
  late final _glTexStorage3D_ptr = _lookup<ffi.NativeFunction<_c_glTexStorage3D>>('glTexStorage3D');
  late final _dart_glTexStorage3D _glTexStorage3D = _glTexStorage3D_ptr.asFunction<_dart_glTexStorage3D>();
  ...
  late final _glGetInternalformativ_ptr =
      _lookup<ffi.NativeFunction<_c_glGetInternalformativ>>('glGetInternalformativ');
  ...
  late final _glDispatchCompute_ptr = _lookup<ffi.NativeFunction<_c_glDispatchCompute>>('glDispatchCompute');
  late final _dart_glDispatchCompute _glDispatchCompute = _glDispatchCompute_ptr.asFunction<_dart_glDispatchCompute>();
  ...
  late final _glDispatchComputeIndirect_ptr =
      _lookup<ffi.NativeFunction<_c_glDispatchComputeIndirect>>('glDispatchComputeIndirect');
  late final _dart_glDispatchComputeIndirect _glDispatchComputeIndirect =
      _glDispatchComputeIndirect_ptr.asFunction<_dart_glDispatchComputeIndirect>();
  ...
  late final _glDrawArraysIndirect_ptr = _lookup<ffi.NativeFunction<_c_glDrawArraysIndirect>>('glDrawArraysIndirect');
  ...
  late final _glDrawElementsIndirect_ptr =
      _lookup<ffi.NativeFunction<_c_glDrawElementsIndirect>>('glDrawElementsIndirect');
  ...
  late final _glFramebufferParameteri_ptr =
      _lookup<ffi.NativeFunction<_c_glFramebufferParameteri>>('glFramebufferParameteri');
  ...
  late final _glGetFramebufferParameteriv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetFramebufferParameteriv>>('glGetFramebufferParameteriv');
  late final _dart_glGetFramebufferParameteriv _glGetFramebufferParameteriv =
      _glGetFramebufferParameteriv_ptr.asFunction<_dart_glGetFramebufferParameteriv>();
  ...
  late final _glGetProgramInterfaceiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramInterfaceiv>>('glGetProgramInterfaceiv');
  ...
  late final _glGetProgramResourceIndex_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramResourceIndex>>('glGetProgramResourceIndex');
  late final _dart_glGetProgramResourceIndex _glGetProgramResourceIndex =
      _glGetProgramResourceIndex_ptr.asFunction<_dart_glGetProgramResourceIndex>();
  ...
  late final _glGetProgramResourceName_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramResourceName>>('glGetProgramResourceName');
  late final _dart_glGetProgramResourceName _glGetProgramResourceName =
      _glGetProgramResourceName_ptr.asFunction<_dart_glGetProgramResourceName>();
  ...
  late final _glGetProgramResourceiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramResourceiv>>('glGetProgramResourceiv');
  ...
  late final _glGetProgramResourceLocation_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramResourceLocation>>('glGetProgramResourceLocation');
  late final _dart_glGetProgramResourceLocation _glGetProgramResourceLocation =
      _glGetProgramResourceLocation_ptr.asFunction<_dart_glGetProgramResourceLocation>();
  ...
  late final _glUseProgramStages_ptr = _lookup<ffi.NativeFunction<_c_glUseProgramStages>>('glUseProgramStages');
  ...
  late final _glActiveShaderProgram_ptr =
      _lookup<ffi.NativeFunction<_c_glActiveShaderProgram>>('glActiveShaderProgram');
  ...
  late final _glCreateShaderProgramv_ptr =
      _lookup<ffi.NativeFunction<_c_glCreateShaderProgramv>>('glCreateShaderProgramv');
  ...
  late final _glBindProgramPipeline_ptr =
      _lookup<ffi.NativeFunction<_c_glBindProgramPipeline>>('glBindProgramPipeline');
  ...
  late final _glDeleteProgramPipelines_ptr =
      _lookup<ffi.NativeFunction<_c_glDeleteProgramPipelines>>('glDeleteProgramPipelines');
  late final _dart_glDeleteProgramPipelines _glDeleteProgramPipelines =
      _glDeleteProgramPipelines_ptr.asFunction<_dart_glDeleteProgramPipelines>();
  ...
  late final _glGenProgramPipelines_ptr =
      _lookup<ffi.NativeFunction<_c_glGenProgramPipelines>>('glGenProgramPipelines');
  ...
  late final _glIsProgramPipeline_ptr = _lookup<ffi.NativeFunction<_c_glIsProgramPipeline>>('glIsProgramPipeline');
  ...
  late final _glGetProgramPipelineiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramPipelineiv>>('glGetProgramPipelineiv');
  ...
  late final _glProgramUniform1i_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform1i>>('glProgramUniform1i');
  ...
  late final _glProgramUniform2i_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform2i>>('glProgramUniform2i');
  ...
  late final _glProgramUniform3i_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform3i>>('glProgramUniform3i');
  ...
  late final _glProgramUniform4i_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform4i>>('glProgramUniform4i');
  ...
  late final _glProgramUniform1ui_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform1ui>>('glProgramUniform1ui');
  ...
  late final _glProgramUniform2ui_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform2ui>>('glProgramUniform2ui');
  ...
  late final _glProgramUniform3ui_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform3ui>>('glProgramUniform3ui');
  ...
  late final _glProgramUniform4ui_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform4ui>>('glProgramUniform4ui');
  ...
  late final _glProgramUniform1f_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform1f>>('glProgramUniform1f');
  ...
  late final _glProgramUniform2f_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform2f>>('glProgramUniform2f');
  ...
  late final _glProgramUniform3f_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform3f>>('glProgramUniform3f');
  ...
  late final _glProgramUniform4f_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform4f>>('glProgramUniform4f');
  ...
  late final _glProgramUniform1iv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform1iv>>('glProgramUniform1iv');
  ...
  late final _glProgramUniform2iv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform2iv>>('glProgramUniform2iv');
  ...
  late final _glProgramUniform3iv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform3iv>>('glProgramUniform3iv');
  ...
  late final _glProgramUniform4iv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform4iv>>('glProgramUniform4iv');
  ...
  late final _glProgramUniform1uiv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform1uiv>>('glProgramUniform1uiv');
  ...
  late final _glProgramUniform2uiv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform2uiv>>('glProgramUniform2uiv');
  ...
  late final _glProgramUniform3uiv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform3uiv>>('glProgramUniform3uiv');
  ...
  late final _glProgramUniform4uiv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform4uiv>>('glProgramUniform4uiv');
  ...
  late final _glProgramUniform1fv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform1fv>>('glProgramUniform1fv');
  ...
  late final _glProgramUniform2fv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform2fv>>('glProgramUniform2fv');
  ...
  late final _glProgramUniform3fv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform3fv>>('glProgramUniform3fv');
  ...
  late final _glProgramUniform4fv_ptr = _lookup<ffi.NativeFunction<_c_glProgramUniform4fv>>('glProgramUniform4fv');
  ...
  late final _glProgramUniformMatrix2fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix2fv>>('glProgramUniformMatrix2fv');
  late final _dart_glProgramUniformMatrix2fv _glProgramUniformMatrix2fv =
      _glProgramUniformMatrix2fv_ptr.asFunction<_dart_glProgramUniformMatrix2fv>();
  ...
  late final _glProgramUniformMatrix3fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix3fv>>('glProgramUniformMatrix3fv');
  late final _dart_glProgramUniformMatrix3fv _glProgramUniformMatrix3fv =
      _glProgramUniformMatrix3fv_ptr.asFunction<_dart_glProgramUniformMatrix3fv>();
  ...
  late final _glProgramUniformMatrix4fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix4fv>>('glProgramUniformMatrix4fv');
  late final _dart_glProgramUniformMatrix4fv _glProgramUniformMatrix4fv =
      _glProgramUniformMatrix4fv_ptr.asFunction<_dart_glProgramUniformMatrix4fv>();
  ...
  late final _glProgramUniformMatrix2x3fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix2x3fv>>('glProgramUniformMatrix2x3fv');
  late final _dart_glProgramUniformMatrix2x3fv _glProgramUniformMatrix2x3fv =
      _glProgramUniformMatrix2x3fv_ptr.asFunction<_dart_glProgramUniformMatrix2x3fv>();
  ...
  late final _glProgramUniformMatrix3x2fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix3x2fv>>('glProgramUniformMatrix3x2fv');
  late final _dart_glProgramUniformMatrix3x2fv _glProgramUniformMatrix3x2fv =
      _glProgramUniformMatrix3x2fv_ptr.asFunction<_dart_glProgramUniformMatrix3x2fv>();
  ...
  late final _glProgramUniformMatrix2x4fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix2x4fv>>('glProgramUniformMatrix2x4fv');
  late final _dart_glProgramUniformMatrix2x4fv _glProgramUniformMatrix2x4fv =
      _glProgramUniformMatrix2x4fv_ptr.asFunction<_dart_glProgramUniformMatrix2x4fv>();
  ...
  late final _glProgramUniformMatrix4x2fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix4x2fv>>('glProgramUniformMatrix4x2fv');
  late final _dart_glProgramUniformMatrix4x2fv _glProgramUniformMatrix4x2fv =
      _glProgramUniformMatrix4x2fv_ptr.asFunction<_dart_glProgramUniformMatrix4x2fv>();
  ...
  late final _glProgramUniformMatrix3x4fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix3x4fv>>('glProgramUniformMatrix3x4fv');
  late final _dart_glProgramUniformMatrix3x4fv _glProgramUniformMatrix3x4fv =
      _glProgramUniformMatrix3x4fv_ptr.asFunction<_dart_glProgramUniformMatrix3x4fv>();
  ...
  late final _glProgramUniformMatrix4x3fv_ptr =
      _lookup<ffi.NativeFunction<_c_glProgramUniformMatrix4x3fv>>('glProgramUniformMatrix4x3fv');
  late final _dart_glProgramUniformMatrix4x3fv _glProgramUniformMatrix4x3fv =
      _glProgramUniformMatrix4x3fv_ptr.asFunction<_dart_glProgramUniformMatrix4x3fv>();
  ...
  late final _glValidateProgramPipeline_ptr =
      _lookup<ffi.NativeFunction<_c_glValidateProgramPipeline>>('glValidateProgramPipeline');
  late final _dart_glValidateProgramPipeline _glValidateProgramPipeline =
      _glValidateProgramPipeline_ptr.asFunction<_dart_glValidateProgramPipeline>();
  ...
  late final _glGetProgramPipelineInfoLog_ptr =
      _lookup<ffi.NativeFunction<_c_glGetProgramPipelineInfoLog>>('glGetProgramPipelineInfoLog');
  late final _dart_glGetProgramPipelineInfoLog _glGetProgramPipelineInfoLog =
      _glGetProgramPipelineInfoLog_ptr.asFunction<_dart_glGetProgramPipelineInfoLog>();
  ...
  late final _glBindImageTexture_ptr = _lookup<ffi.NativeFunction<_c_glBindImageTexture>>('glBindImageTexture');
  ...
  late final _glGetBooleani_v_ptr = _lookup<ffi.NativeFunction<_c_glGetBooleani_v>>('glGetBooleani_v');
  late final _dart_glGetBooleani_v _glGetBooleani_v = _glGetBooleani_v_ptr.asFunction<_dart_glGetBooleani_v>();
  ...
  late final _glMemoryBarrier_ptr = _lookup<ffi.NativeFunction<_c_glMemoryBarrier>>('glMemoryBarrier');
  late final _dart_glMemoryBarrier _glMemoryBarrier = _glMemoryBarrier_ptr.asFunction<_dart_glMemoryBarrier>();
  ...
  late final _glMemoryBarrierByRegion_ptr =
      _lookup<ffi.NativeFunction<_c_glMemoryBarrierByRegion>>('glMemoryBarrierByRegion');
  ...
  late final _glTexStorage2DMultisample_ptr =
      _lookup<ffi.NativeFunction<_c_glTexStorage2DMultisample>>('glTexStorage2DMultisample');
  late final _dart_glTexStorage2DMultisample _glTexStorage2DMultisample =
      _glTexStorage2DMultisample_ptr.asFunction<_dart_glTexStorage2DMultisample>();
  ...
  late final _glGetMultisamplefv_ptr = _lookup<ffi.NativeFunction<_c_glGetMultisamplefv>>('glGetMultisamplefv');
  ...
  late final _glSampleMaski_ptr = _lookup<ffi.NativeFunction<_c_glSampleMaski>>('glSampleMaski');
  late final _dart_glSampleMaski _glSampleMaski = _glSampleMaski_ptr.asFunction<_dart_glSampleMaski>();
  ...
  late final _glGetTexLevelParameteriv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetTexLevelParameteriv>>('glGetTexLevelParameteriv');
  late final _dart_glGetTexLevelParameteriv _glGetTexLevelParameteriv =
      _glGetTexLevelParameteriv_ptr.asFunction<_dart_glGetTexLevelParameteriv>();
  ...
  late final _glGetTexLevelParameterfv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetTexLevelParameterfv>>('glGetTexLevelParameterfv');
  late final _dart_glGetTexLevelParameterfv _glGetTexLevelParameterfv =
      _glGetTexLevelParameterfv_ptr.asFunction<_dart_glGetTexLevelParameterfv>();
  ...
  late final _glBindVertexBuffer_ptr = _lookup<ffi.NativeFunction<_c_glBindVertexBuffer>>('glBindVertexBuffer');
  ...
  late final _glVertexAttribFormat_ptr = _lookup<ffi.NativeFunction<_c_glVertexAttribFormat>>('glVertexAttribFormat');
  ...
  late final _glVertexAttribIFormat_ptr =
      _lookup<ffi.NativeFunction<_c_glVertexAttribIFormat>>('glVertexAttribIFormat');
  ...
  late final _glVertexAttribBinding_ptr =
      _lookup<ffi.NativeFunction<_c_glVertexAttribBinding>>('glVertexAttribBinding');
  ...
  late final _glVertexBindingDivisor_ptr =
      _lookup<ffi.NativeFunction<_c_glVertexBindingDivisor>>('glVertexBindingDivisor');
  ...
  late final _glBlendBarrier_ptr = _lookup<ffi.NativeFunction<_c_glBlendBarrier>>('glBlendBarrier');
  late final _dart_glBlendBarrier _glBlendBarrier = _glBlendBarrier_ptr.asFunction<_dart_glBlendBarrier>();
  ...
  late final _glCopyImageSubData_ptr = _lookup<ffi.NativeFunction<_c_glCopyImageSubData>>('glCopyImageSubData');
  ...
  late final _glDebugMessageControl_ptr =
      _lookup<ffi.NativeFunction<_c_glDebugMessageControl>>('glDebugMessageControl');
  ...
  late final _glDebugMessageInsert_ptr = _lookup<ffi.NativeFunction<_c_glDebugMessageInsert>>('glDebugMessageInsert');
  ...
  late final _glDebugMessageCallback_ptr =
      _lookup<ffi.NativeFunction<_c_glDebugMessageCallback>>('glDebugMessageCallback');
  ...
  late final _glGetDebugMessageLog_ptr = _lookup<ffi.NativeFunction<_c_glGetDebugMessageLog>>('glGetDebugMessageLog');
  ...
  late final _glPushDebugGroup_ptr = _lookup<ffi.NativeFunction<_c_glPushDebugGroup>>('glPushDebugGroup');
  late final _dart_glPushDebugGroup _glPushDebugGroup = _glPushDebugGroup_ptr.asFunction<_dart_glPushDebugGroup>();

  void glPopDebugGroup() {
    return _glPopDebugGroup();
  }

  late final _glPopDebugGroup_ptr = _lookup<ffi.NativeFunction<_c_glPopDebugGroup>>('glPopDebugGroup');
  late final _dart_glPopDebugGroup _glPopDebugGroup = _glPopDebugGroup_ptr.asFunction<_dart_glPopDebugGroup>();
  ...
  late final _glObjectLabel_ptr = _lookup<ffi.NativeFunction<_c_glObjectLabel>>('glObjectLabel');
  late final _dart_glObjectLabel _glObjectLabel = _glObjectLabel_ptr.asFunction<_dart_glObjectLabel>();
  ...
  late final _glGetObjectLabel_ptr = _lookup<ffi.NativeFunction<_c_glGetObjectLabel>>('glGetObjectLabel');
  late final _dart_glGetObjectLabel _glGetObjectLabel = _glGetObjectLabel_ptr.asFunction<_dart_glGetObjectLabel>();
  ...
  late final _glObjectPtrLabel_ptr = _lookup<ffi.NativeFunction<_c_glObjectPtrLabel>>('glObjectPtrLabel');
  late final _dart_glObjectPtrLabel _glObjectPtrLabel = _glObjectPtrLabel_ptr.asFunction<_dart_glObjectPtrLabel>();
  ...
  late final _glGetObjectPtrLabel_ptr = _lookup<ffi.NativeFunction<_c_glGetObjectPtrLabel>>('glGetObjectPtrLabel');
  ...
  late final _glGetPointerv_ptr = _lookup<ffi.NativeFunction<_c_glGetPointerv>>('glGetPointerv');
  late final _dart_glGetPointerv _glGetPointerv = _glGetPointerv_ptr.asFunction<_dart_glGetPointerv>();
  ...
  late final _glEnablei_ptr = _lookup<ffi.NativeFunction<_c_glEnablei>>('glEnablei');
  late final _dart_glEnablei _glEnablei = _glEnablei_ptr.asFunction<_dart_glEnablei>();
  ...
  late final _glDisablei_ptr = _lookup<ffi.NativeFunction<_c_glDisablei>>('glDisablei');
  late final _dart_glDisablei _glDisablei = _glDisablei_ptr.asFunction<_dart_glDisablei>();
  ...
  late final _glBlendEquationi_ptr = _lookup<ffi.NativeFunction<_c_glBlendEquationi>>('glBlendEquationi');
  late final _dart_glBlendEquationi _glBlendEquationi = _glBlendEquationi_ptr.asFunction<_dart_glBlendEquationi>();
  ...
  late final _glBlendEquationSeparatei_ptr =
      _lookup<ffi.NativeFunction<_c_glBlendEquationSeparatei>>('glBlendEquationSeparatei');
  late final _dart_glBlendEquationSeparatei _glBlendEquationSeparatei =
      _glBlendEquationSeparatei_ptr.asFunction<_dart_glBlendEquationSeparatei>();
  ...
  late final _glBlendFunci_ptr = _lookup<ffi.NativeFunction<_c_glBlendFunci>>('glBlendFunci');
  late final _dart_glBlendFunci _glBlendFunci = _glBlendFunci_ptr.asFunction<_dart_glBlendFunci>();
  ...
  late final _glBlendFuncSeparatei_ptr = _lookup<ffi.NativeFunction<_c_glBlendFuncSeparatei>>('glBlendFuncSeparatei');
  ...
  late final _glColorMaski_ptr = _lookup<ffi.NativeFunction<_c_glColorMaski>>('glColorMaski');
  late final _dart_glColorMaski _glColorMaski = _glColorMaski_ptr.asFunction<_dart_glColorMaski>();
  ...
  late final _glIsEnabledi_ptr = _lookup<ffi.NativeFunction<_c_glIsEnabledi>>('glIsEnabledi');
  late final _dart_glIsEnabledi _glIsEnabledi = _glIsEnabledi_ptr.asFunction<_dart_glIsEnabledi>();
  ...
  late final _glDrawElementsBaseVertex_ptr =
      _lookup<ffi.NativeFunction<_c_glDrawElementsBaseVertex>>('glDrawElementsBaseVertex');
  late final _dart_glDrawElementsBaseVertex _glDrawElementsBaseVertex =
      _glDrawElementsBaseVertex_ptr.asFunction<_dart_glDrawElementsBaseVertex>();
  ...
  late final _glDrawRangeElementsBaseVertex_ptr =
      _lookup<ffi.NativeFunction<_c_glDrawRangeElementsBaseVertex>>('glDrawRangeElementsBaseVertex');
  late final _dart_glDrawRangeElementsBaseVertex _glDrawRangeElementsBaseVertex =
      _glDrawRangeElementsBaseVertex_ptr.asFunction<_dart_glDrawRangeElementsBaseVertex>();
  ...
  late final _glDrawElementsInstancedBaseVertex_ptr =
      _lookup<ffi.NativeFunction<_c_glDrawElementsInstancedBaseVertex>>('glDrawElementsInstancedBaseVertex');
  late final _dart_glDrawElementsInstancedBaseVertex _glDrawElementsInstancedBaseVertex =
      _glDrawElementsInstancedBaseVertex_ptr.asFunction<_dart_glDrawElementsInstancedBaseVertex>();
  ...
  late final _glFramebufferTexture_ptr = _lookup<ffi.NativeFunction<_c_glFramebufferTexture>>('glFramebufferTexture');
  ...
  late final _glPrimitiveBoundingBox_ptr =
      _lookup<ffi.NativeFunction<_c_glPrimitiveBoundingBox>>('glPrimitiveBoundingBox');
  ...
  late final _glGetGraphicsResetStatus_ptr =
      _lookup<ffi.NativeFunction<_c_glGetGraphicsResetStatus>>('glGetGraphicsResetStatus');
  late final _dart_glGetGraphicsResetStatus _glGetGraphicsResetStatus =
      _glGetGraphicsResetStatus_ptr.asFunction<_dart_glGetGraphicsResetStatus>();
  ...
  late final _glReadnPixels_ptr = _lookup<ffi.NativeFunction<_c_glReadnPixels>>('glReadnPixels');
  late final _dart_glReadnPixels _glReadnPixels = _glReadnPixels_ptr.asFunction<_dart_glReadnPixels>();
  ...
  late final _glGetnUniformfv_ptr = _lookup<ffi.NativeFunction<_c_glGetnUniformfv>>('glGetnUniformfv');
  late final _dart_glGetnUniformfv _glGetnUniformfv = _glGetnUniformfv_ptr.asFunction<_dart_glGetnUniformfv>();
  ...
  late final _glGetnUniformiv_ptr = _lookup<ffi.NativeFunction<_c_glGetnUniformiv>>('glGetnUniformiv');
  late final _dart_glGetnUniformiv _glGetnUniformiv = _glGetnUniformiv_ptr.asFunction<_dart_glGetnUniformiv>();
  ...
  late final _glGetnUniformuiv_ptr = _lookup<ffi.NativeFunction<_c_glGetnUniformuiv>>('glGetnUniformuiv');
  late final _dart_glGetnUniformuiv _glGetnUniformuiv = _glGetnUniformuiv_ptr.asFunction<_dart_glGetnUniformuiv>();
  ...
  late final _glMinSampleShading_ptr = _lookup<ffi.NativeFunction<_c_glMinSampleShading>>('glMinSampleShading');
  ...
  late final _glPatchParameteri_ptr = _lookup<ffi.NativeFunction<_c_glPatchParameteri>>('glPatchParameteri');
  late final _dart_glPatchParameteri _glPatchParameteri = _glPatchParameteri_ptr.asFunction<_dart_glPatchParameteri>();
  ...
  late final _glTexParameterIiv_ptr = _lookup<ffi.NativeFunction<_c_glTexParameterIiv>>('glTexParameterIiv');
  late final _dart_glTexParameterIiv _glTexParameterIiv = _glTexParameterIiv_ptr.asFunction<_dart_glTexParameterIiv>();
  ...
  late final _glTexParameterIuiv_ptr = _lookup<ffi.NativeFunction<_c_glTexParameterIuiv>>('glTexParameterIuiv');
  ...
  late final _glGetTexParameterIiv_ptr = _lookup<ffi.NativeFunction<_c_glGetTexParameterIiv>>('glGetTexParameterIiv');
  ...
  late final _glGetTexParameterIuiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetTexParameterIuiv>>('glGetTexParameterIuiv');
  ...
  late final _glSamplerParameterIiv_ptr =
      _lookup<ffi.NativeFunction<_c_glSamplerParameterIiv>>('glSamplerParameterIiv');
  ...
  late final _glSamplerParameterIuiv_ptr =
      _lookup<ffi.NativeFunction<_c_glSamplerParameterIuiv>>('glSamplerParameterIuiv');
  ...
  late final _glGetSamplerParameterIiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetSamplerParameterIiv>>('glGetSamplerParameterIiv');
  late final _dart_glGetSamplerParameterIiv _glGetSamplerParameterIiv =
      _glGetSamplerParameterIiv_ptr.asFunction<_dart_glGetSamplerParameterIiv>();
  ...
  late final _glGetSamplerParameterIuiv_ptr =
      _lookup<ffi.NativeFunction<_c_glGetSamplerParameterIuiv>>('glGetSamplerParameterIuiv');
  late final _dart_glGetSamplerParameterIuiv _glGetSamplerParameterIuiv =
      _glGetSamplerParameterIuiv_ptr.asFunction<_dart_glGetSamplerParameterIuiv>();
  ...
  late final _glTexBuffer_ptr = _lookup<ffi.NativeFunction<_c_glTexBuffer>>('glTexBuffer');
  late final _dart_glTexBuffer _glTexBuffer = _glTexBuffer_ptr.asFunction<_dart_glTexBuffer>();
  ...
  late final _glTexBufferRange_ptr = _lookup<ffi.NativeFunction<_c_glTexBufferRange>>('glTexBufferRange');
  late final _dart_glTexBufferRange _glTexBufferRange = _glTexBufferRange_ptr.asFunction<_dart_glTexBufferRange>();
  ...
  late final _glTexStorage3DMultisample_ptr =
      _lookup<ffi.NativeFunction<_c_glTexStorage3DMultisample>>('glTexStorage3DMultisample');
  late final _dart_glTexStorage3DMultisample _glTexStorage3DMultisample =
      _glTexStorage3DMultisample_ptr.asFunction<_dart_glTexStorage3DMultisample>();
}
...
const int GL_FRAMEBUFFER_INCOMPLETE_INSUFFICIENT_SHADER_COMBINED_LOCAL_STORAGE_EXT = 38482;

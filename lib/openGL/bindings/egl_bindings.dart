...
// ignore_for_file: camel_case_types, constant_identifier_names, non_constant_identifier_names, unused_element, unused_field
...
class LibEGL {
  ...
  LibEGL.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
  ...
  late final _eglChooseConfig_ptr = _lookup<ffi.NativeFunction<_c_eglChooseConfig>>('eglChooseConfig');
  late final _dart_eglChooseConfig _eglChooseConfig = _eglChooseConfig_ptr.asFunction<_dart_eglChooseConfig>();
  ...
  late final _eglCopyBuffers_ptr = _lookup<ffi.NativeFunction<_c_eglCopyBuffers>>('eglCopyBuffers');
  late final _dart_eglCopyBuffers _eglCopyBuffers = _eglCopyBuffers_ptr.asFunction<_dart_eglCopyBuffers>();
  ...
  late final _eglCreateContext_ptr = _lookup<ffi.NativeFunction<_c_eglCreateContext>>('eglCreateContext');
  late final _dart_eglCreateContext _eglCreateContext = _eglCreateContext_ptr.asFunction<_dart_eglCreateContext>();
  ...
  late final _eglCreatePbufferSurface_ptr =
      _lookup<ffi.NativeFunction<_c_eglCreatePbufferSurface>>('eglCreatePbufferSurface');
  ...
  late final _eglCreatePixmapSurface_ptr =
      _lookup<ffi.NativeFunction<_c_eglCreatePixmapSurface>>('eglCreatePixmapSurface');
  ...
  late final _eglCreateWindowSurface_ptr =
      _lookup<ffi.NativeFunction<_c_eglCreateWindowSurface>>('eglCreateWindowSurface');
  ...
  late final _eglDestroyContext_ptr = _lookup<ffi.NativeFunction<_c_eglDestroyContext>>('eglDestroyContext');
  late final _dart_eglDestroyContext _eglDestroyContext = _eglDestroyContext_ptr.asFunction<_dart_eglDestroyContext>();
  ...
  late final _eglDestroySurface_ptr = _lookup<ffi.NativeFunction<_c_eglDestroySurface>>('eglDestroySurface');
  late final _dart_eglDestroySurface _eglDestroySurface = _eglDestroySurface_ptr.asFunction<_dart_eglDestroySurface>();
  ...
  late final _eglGetConfigAttrib_ptr = _lookup<ffi.NativeFunction<_c_eglGetConfigAttrib>>('eglGetConfigAttrib');
  ...
  late final _eglGetConfigs_ptr = _lookup<ffi.NativeFunction<_c_eglGetConfigs>>('eglGetConfigs');
  late final _dart_eglGetConfigs _eglGetConfigs = _eglGetConfigs_ptr.asFunction<_dart_eglGetConfigs>();

  ffi.Pointer<ffi.Void> eglGetCurrentDisplay() {
    return _eglGetCurrentDisplay();
  }

  late final _eglGetCurrentDisplay_ptr = _lookup<ffi.NativeFunction<_c_eglGetCurrentDisplay>>('eglGetCurrentDisplay');
  ...
  late final _eglGetCurrentSurface_ptr = _lookup<ffi.NativeFunction<_c_eglGetCurrentSurface>>('eglGetCurrentSurface');
  ...
  late final _eglGetDisplay_ptr = _lookup<ffi.NativeFunction<_c_eglGetDisplay>>('eglGetDisplay');
  late final _dart_eglGetDisplay _eglGetDisplay = _eglGetDisplay_ptr.asFunction<_dart_eglGetDisplay>();

  int eglGetError() {
    return _eglGetError();
  }

  late final _eglGetError_ptr = _lookup<ffi.NativeFunction<_c_eglGetError>>('eglGetError');
  late final _dart_eglGetError _eglGetError = _eglGetError_ptr.asFunction<_dart_eglGetError>();

  ffi.Pointer<ffi.NativeFunction<__eglMustCastToProperFunctionPointerType>> eglGetProcAddress(
  ...
  late final _eglGetProcAddress_ptr = _lookup<ffi.NativeFunction<_c_eglGetProcAddress>>('eglGetProcAddress');
  late final _dart_eglGetProcAddress _eglGetProcAddress = _eglGetProcAddress_ptr.asFunction<_dart_eglGetProcAddress>();
  ...
  late final _eglInitialize_ptr = _lookup<ffi.NativeFunction<_c_eglInitialize>>('eglInitialize');
  late final _dart_eglInitialize _eglInitialize = _eglInitialize_ptr.asFunction<_dart_eglInitialize>();
  ...
  late final _eglMakeCurrent_ptr = _lookup<ffi.NativeFunction<_c_eglMakeCurrent>>('eglMakeCurrent');
  late final _dart_eglMakeCurrent _eglMakeCurrent = _eglMakeCurrent_ptr.asFunction<_dart_eglMakeCurrent>();
  ...
  late final _eglQueryContext_ptr = _lookup<ffi.NativeFunction<_c_eglQueryContext>>('eglQueryContext');
  late final _dart_eglQueryContext _eglQueryContext = _eglQueryContext_ptr.asFunction<_dart_eglQueryContext>();
  ...
  late final _eglQueryString_ptr = _lookup<ffi.NativeFunction<_c_eglQueryString>>('eglQueryString');
  late final _dart_eglQueryString _eglQueryString = _eglQueryString_ptr.asFunction<_dart_eglQueryString>();
  ...
  late final _eglQuerySurface_ptr = _lookup<ffi.NativeFunction<_c_eglQuerySurface>>('eglQuerySurface');
  late final _dart_eglQuerySurface _eglQuerySurface = _eglQuerySurface_ptr.asFunction<_dart_eglQuerySurface>();
  ...
  late final _eglSwapBuffers_ptr = _lookup<ffi.NativeFunction<_c_eglSwapBuffers>>('eglSwapBuffers');
  late final _dart_eglSwapBuffers _eglSwapBuffers = _eglSwapBuffers_ptr.asFunction<_dart_eglSwapBuffers>();
  ...
  late final _eglTerminate_ptr = _lookup<ffi.NativeFunction<_c_eglTerminate>>('eglTerminate');
  late final _dart_eglTerminate _eglTerminate = _eglTerminate_ptr.asFunction<_dart_eglTerminate>();

  int eglWaitGL() {
    return _eglWaitGL();
  }

  late final _eglWaitGL_ptr = _lookup<ffi.NativeFunction<_c_eglWaitGL>>('eglWaitGL');
  late final _dart_eglWaitGL _eglWaitGL = _eglWaitGL_ptr.asFunction<_dart_eglWaitGL>();
  ...
  late final _eglWaitNative_ptr = _lookup<ffi.NativeFunction<_c_eglWaitNative>>('eglWaitNative');
  late final _dart_eglWaitNative _eglWaitNative = _eglWaitNative_ptr.asFunction<_dart_eglWaitNative>();
  ...
  late final _eglBindTexImage_ptr = _lookup<ffi.NativeFunction<_c_eglBindTexImage>>('eglBindTexImage');
  late final _dart_eglBindTexImage _eglBindTexImage = _eglBindTexImage_ptr.asFunction<_dart_eglBindTexImage>();
  ...
  late final _eglReleaseTexImage_ptr = _lookup<ffi.NativeFunction<_c_eglReleaseTexImage>>('eglReleaseTexImage');
  ...
  late final _eglSurfaceAttrib_ptr = _lookup<ffi.NativeFunction<_c_eglSurfaceAttrib>>('eglSurfaceAttrib');
  late final _dart_eglSurfaceAttrib _eglSurfaceAttrib = _eglSurfaceAttrib_ptr.asFunction<_dart_eglSurfaceAttrib>();
  ...
  late final _eglSwapInterval_ptr = _lookup<ffi.NativeFunction<_c_eglSwapInterval>>('eglSwapInterval');
  late final _dart_eglSwapInterval _eglSwapInterval = _eglSwapInterval_ptr.asFunction<_dart_eglSwapInterval>();
  ...
  late final _eglBindAPI_ptr = _lookup<ffi.NativeFunction<_c_eglBindAPI>>('eglBindAPI');
  late final _dart_eglBindAPI _eglBindAPI = _eglBindAPI_ptr.asFunction<_dart_eglBindAPI>();

  int eglQueryAPI() {
    return _eglQueryAPI();
  }

  late final _eglQueryAPI_ptr = _lookup<ffi.NativeFunction<_c_eglQueryAPI>>('eglQueryAPI');
  late final _dart_eglQueryAPI _eglQueryAPI = _eglQueryAPI_ptr.asFunction<_dart_eglQueryAPI>();
  ...
  late final _eglCreatePbufferFromClientBuffer_ptr =
      _lookup<ffi.NativeFunction<_c_eglCreatePbufferFromClientBuffer>>('eglCreatePbufferFromClientBuffer');
  late final _dart_eglCreatePbufferFromClientBuffer _eglCreatePbufferFromClientBuffer =
      _eglCreatePbufferFromClientBuffer_ptr.asFunction<_dart_eglCreatePbufferFromClientBuffer>();

  int eglReleaseThread() {
    return _eglReleaseThread();
  }

  late final _eglReleaseThread_ptr = _lookup<ffi.NativeFunction<_c_eglReleaseThread>>('eglReleaseThread');
  late final _dart_eglReleaseThread _eglReleaseThread = _eglReleaseThread_ptr.asFunction<_dart_eglReleaseThread>();

  int eglWaitClient() {
    return _eglWaitClient();
  }

  late final _eglWaitClient_ptr = _lookup<ffi.NativeFunction<_c_eglWaitClient>>('eglWaitClient');
  late final _dart_eglWaitClient _eglWaitClient = _eglWaitClient_ptr.asFunction<_dart_eglWaitClient>();

  ffi.Pointer<ffi.Void> eglGetCurrentContext() {
    return _eglGetCurrentContext();
  }

  late final _eglGetCurrentContext_ptr = _lookup<ffi.NativeFunction<_c_eglGetCurrentContext>>('eglGetCurrentContext');
  ...
  late final _eglCreateSync_ptr = _lookup<ffi.NativeFunction<_c_eglCreateSync>>('eglCreateSync');
  late final _dart_eglCreateSync _eglCreateSync = _eglCreateSync_ptr.asFunction<_dart_eglCreateSync>();
  ...
  late final _eglDestroySync_ptr = _lookup<ffi.NativeFunction<_c_eglDestroySync>>('eglDestroySync');
  late final _dart_eglDestroySync _eglDestroySync = _eglDestroySync_ptr.asFunction<_dart_eglDestroySync>();
  ...
  late final _eglClientWaitSync_ptr = _lookup<ffi.NativeFunction<_c_eglClientWaitSync>>('eglClientWaitSync');
  late final _dart_eglClientWaitSync _eglClientWaitSync = _eglClientWaitSync_ptr.asFunction<_dart_eglClientWaitSync>();
  ...
  late final _eglGetSyncAttrib_ptr = _lookup<ffi.NativeFunction<_c_eglGetSyncAttrib>>('eglGetSyncAttrib');
  late final _dart_eglGetSyncAttrib _eglGetSyncAttrib = _eglGetSyncAttrib_ptr.asFunction<_dart_eglGetSyncAttrib>();
  ...
  late final _eglCreateImage_ptr = _lookup<ffi.NativeFunction<_c_eglCreateImage>>('eglCreateImage');
  late final _dart_eglCreateImage _eglCreateImage = _eglCreateImage_ptr.asFunction<_dart_eglCreateImage>();
  ...
  late final _eglDestroyImage_ptr = _lookup<ffi.NativeFunction<_c_eglDestroyImage>>('eglDestroyImage');
  late final _dart_eglDestroyImage _eglDestroyImage = _eglDestroyImage_ptr.asFunction<_dart_eglDestroyImage>();
  ...
  late final _eglGetPlatformDisplay_ptr =
      _lookup<ffi.NativeFunction<_c_eglGetPlatformDisplay>>('eglGetPlatformDisplay');
  ...
  late final _eglCreatePlatformWindowSurface_ptr =
      _lookup<ffi.NativeFunction<_c_eglCreatePlatformWindowSurface>>('eglCreatePlatformWindowSurface');
  late final _dart_eglCreatePlatformWindowSurface _eglCreatePlatformWindowSurface =
      _eglCreatePlatformWindowSurface_ptr.asFunction<_dart_eglCreatePlatformWindowSurface>();
  ...
  late final _eglCreatePlatformPixmapSurface_ptr =
      _lookup<ffi.NativeFunction<_c_eglCreatePlatformPixmapSurface>>('eglCreatePlatformPixmapSurface');
  late final _dart_eglCreatePlatformPixmapSurface _eglCreatePlatformPixmapSurface =
      _eglCreatePlatformPixmapSurface_ptr.asFunction<_dart_eglCreatePlatformPixmapSurface>();
  ...
  late final _eglWaitSync_ptr = _lookup<ffi.NativeFunction<_c_eglWaitSync>>('eglWaitSync');
  late final _dart_eglWaitSync _eglWaitSync = _eglWaitSync_ptr.asFunction<_dart_eglWaitSync>();
  ...
  late final _makeCurrent_ptr = _lookup<ffi.NativeFunction<_c_makeCurrent>>('makeCurrent');
  late final _dart_makeCurrent _makeCurrent = _makeCurrent_ptr.asFunction<_dart_makeCurrent>();
}
...
typedef _c_eglGetProcAddress = ffi.Pointer<ffi.NativeFunction<__eglMustCastToProperFunctionPointerType>> Function(
  ffi.Pointer<ffi.Int8> procname,
);

typedef _dart_eglGetProcAddress = ffi.Pointer<ffi.NativeFunction<__eglMustCastToProperFunctionPointerType>> Function(
  ffi.Pointer<ffi.Int8> procname,
);

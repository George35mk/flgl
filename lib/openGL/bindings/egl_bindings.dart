...
class LibEGL {
  ...
  LibEGL.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup)
      : _lookup = lookup;
  ...
  late final _eglGetCurrentDisplay_ptr =
      _lookup<ffi.NativeFunction<_c_eglGetCurrentDisplay>>('eglGetCurrentDisplay');
  ...
  late final _eglGetCurrentSurface_ptr =
      _lookup<ffi.NativeFunction<_c_eglGetCurrentSurface>>('eglGetCurrentSurface');
  ...
  late final _eglGetCurrentContext_ptr =
      _lookup<ffi.NativeFunction<_c_eglGetCurrentContext>>('eglGetCurrentContext');
...
typedef _c_eglGetProcAddress
    = ffi.Pointer<ffi.NativeFunction<__eglMustCastToProperFunctionPointerType>> Function(
  ffi.Pointer<ffi.Int8> procname,
);

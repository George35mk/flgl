...
class NeonSphereExample extends StatefulWidget {
  const NeonSphereExample({Key? key}) : super(key: key);

  @override
  _NeonSphereExampleState createState() => _NeonSphereExampleState();
}

class _NeonSphereExampleState extends State<NeonSphereExample> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Neon: Sphere example"),
      ),
      body: Stack(
        children: [
          FLGLViewport(
  ...
  initScene() async {
    ...
    var geometry = NeonSphereGeometry(radius: 50, subdivisionsAxis: 25, subdivisionsHeight: 25);

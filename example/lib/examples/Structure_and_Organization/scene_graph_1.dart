...
class SceneGraph1 extends StatefulWidget {
  const SceneGraph1({Key? key}) : super(key: key);

  @override
  _SceneGraph1State createState() => _SceneGraph1State();
}

class _SceneGraph1State extends State<SceneGraph1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("3D Scene graph 1"),
      ),
      body: Column(
        children: [
          GestureDetector(

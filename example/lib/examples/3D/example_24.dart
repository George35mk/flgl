...
class Example24 extends StatefulWidget {
  ...
  @override
  _Example24State createState() => _Example24State();
}
...
class _Example24State extends State<Example24> {
  ...
  void initState() {
    ...
    controlsManager!.add(TransformControl(name: 'FoV', min: 1, max: 180, value: fieldOfViewRadians));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Example 24 (3D Perspective 4)"),
      ),
      body: Column(
        children: [
          Stack(

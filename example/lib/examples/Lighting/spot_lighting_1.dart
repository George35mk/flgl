...
class SpotLight1 extends StatefulWidget {
  const SpotLight1({Key? key}) : super(key: key);

  @override
  _SpotLight1State createState() => _SpotLight1State();
}

class _SpotLight1State extends State<SpotLight1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("3D Spot Light 1"),
      ),
      body: Column(
        children: [
          Stack(

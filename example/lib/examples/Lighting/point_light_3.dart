...
class PointLight3 extends StatefulWidget {
  const PointLight3({Key? key}) : super(key: key);

  @override
  _PointLight3State createState() => _PointLight3State();
}

class _PointLight3State extends State<PointLight3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("3D Point Lighting 3 (specular highlighting + shininess)"),
      ),
      body: Column(
        children: [
          Stack(

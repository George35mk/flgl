...
class SpotLight2 extends StatefulWidget {
  const SpotLight2({Key? key}) : super(key: key);

  @override
  _SpotLight2State createState() => _SpotLight2State();
}

class _SpotLight2State extends State<SpotLight2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("3D Spot Light 2"),
      ),
      body: Column(
        children: [
          Stack(
